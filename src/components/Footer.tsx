        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
             ...
             <li><Link to="/livro-autoral" className="text-sm text-primary-foreground/70 hover:text-gold transition-colors">Livro Autoral Create Travel</Link></li>
             <li><Link to="/depoimentos" className="text-sm text-primary-foreground/70 hover:text-gold transition-colors">Nós viajamos!</Link></li>
              <li><Link to="/perguntas-frequentes" className="text-sm text-primary-foreground/70 hover:text-gold transition-colors">Perguntas frequentes</Link></li>
