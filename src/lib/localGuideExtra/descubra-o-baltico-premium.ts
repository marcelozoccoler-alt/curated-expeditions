...
export const descubraOBalticoPremium: LocalGuideGroup = {
  slug: "descubra-o-baltico-premium",
  code: "DBAL",
  title: "Descubra o Báltico (Premium)",
  ...
  priceNote:
    "5% de desconto para o terceiro passageiro em quarto triplo. Redução de € 500 por pessoa em apto. duplo (€ 240 suplemento individual) para quem terminar o circuito em Vilnius no dia 8, com traslado ao aeroporto incluído.",
  ...
  departures: [
    ...
    "2027-08-03", "2027-08-17", "2027-08-31",
