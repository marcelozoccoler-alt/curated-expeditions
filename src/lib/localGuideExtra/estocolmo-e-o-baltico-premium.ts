...
export const estocolmoEOBalticoPremium: LocalGuideGroup = {
  slug: "estocolmo-e-o-baltico-premium",
  code: "EBAL",
  title: "Estocolmo e o Báltico (Premium)",
  ...
  nights: 12,
  priceEur: 3050,
  singleSupplementEur: 1440,
  priceNote:
    "5% de desconto para o terceiro passageiro em quarto triplo. Redução de € 500 por pessoa em apto. duplo (€ 200 suplemento individual) para quem terminar o circuito em Vilnius no dia 11, com traslado ao aeroporto incluído.",
  ...
  departures: [
    ...
    "2027-07-03", "2027-07-17", "2027-07-31",
    "2027-08-14", "2027-08-28",
    "2027-09-11", "2027-09-25",
  ],
  itinerary: [
    {
      day: 1,
