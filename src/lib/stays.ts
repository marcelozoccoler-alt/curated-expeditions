...
export const stays: Stay[] = [
  ...
  },
  {
    ...
    imageAiPrompt: "Ultra realistic editorial photo of a luxury bungalow in Fernando de Noronha overlooking Baía do Sueste, panoramic ocean view, no people.",
    imageOverrideUrl: "https://static.pmweb.com.br/XSQnhXPxGnNQKN8EFWfArvlghHg=/https://letsimage.s3.amazonaws.com/editor/nannai/imgs/1749836804503-nannai-sintonnia-vista-panoramica-baia-sueste.png",
    whySelected: "Hospedagem boutique sobre a Baía do Sueste, com vistas panorâmicas, serviço atencioso e acesso privilegiado ao arquipélago mais protegido do Brasil.",
    beyondUsual: [
      "Mergulhos guiados em pontos menos visitados do arquipélago.",
      "Trilhas privativas ao nascer do sol nos mirantes da ilha.",
      "Experiências gastronômicas com peixes do dia e ingredientes locais.",
    ],
    faq: [
