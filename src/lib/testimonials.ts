...
import labibSevilhaBancoAlmeria from "@/assets/depoimentos/labib-sevilha-plaza-espana-banco-almeria.jpg.asset.json";
...
export const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    photos: [
      ...
      {
        src: labibSevilhaAmigas.url,
        caption: "Sevilha: as duas amigas na Plaza de España",
        alt: "Labib e a amiga Rosinha na Plaza de España, em Sevilha, com as arcadas de tijolo e o canal ao fundo",
      },
      {
        src: labibSevilhaBancoAlmeria.url,
        caption: "O banco de azulejos de Almería, um para cada província",
        alt: "Viajante sentada no banco de azulejos pintados dedicado a Almería, na Plaza de España de Sevilha, Espanha",
      },
      {
        src: labibSevilhaPraca.url,
        caption: "A praça inteira ao sol do meio-dia",
        alt: "Vista ampla da Plaza de España em Sevilha, com arcadas, torres e piso de cerâmica sob céu azul",
      },
      {
        src: labibToledoSanJuan.url,
      ...
      {
        src: labibVienaBelvedereJardim.url,
        caption: "Viena: o Belvedere refletido no espelho de água",
        alt: "Palácio Belvedere de Viena refletido no espelho de água do jardim barroco, com canteiros floridos",
      },
      {
        src: labibVienaGrinzing.url,
