...
import { polosExtraDestinations } from "./destinationsExtra/polos";
import { caucasoAsiaExtraDestinations } from "./destinationsExtra/caucasoAsia";
import { andesAlpesExtraDestinations } from "./destinationsExtra/andesAlpes";
import { wildAsiaPacificoDestinations } from "./destinationsExtra/wildAsiaPacifico";
import { wildAfricaAmericasDestinations } from "./destinationsExtra/wildAfricaAmericas";
...
const baseDestinations: Destination[] = [
  ...
  {
    id: "asia-china-classica",
    continent: "Ásia",
    country: "China",
    region: "Beijing, Xi'an & Shanghai",
    slug: "asia/china/classica",
    name: "China Clássica",
    bestTime: "Abr–Mai e Set–Out (primavera e outono dourado); evite Jul–Ago (calor úmido) e feriado nacional 01–07/10.",
    tags: ["cultura", "gastronomia", "fotografia", "roteiro-classico", "trekking"],
    imageAiPrompt: "Ultra realistic editorial photo of Forbidden City rooftops at sunset in Beijing, golden tiles glowing, cinematic warm autumn light, no people.",
    imageOverrideUrl: chinaClassicaImg,
    intro: "Beijing imperial, Grande Muralha entre montanhas, Guerreiros de Terracota em Xi'an e Shanghai futurista: a China clássica em cinco milênios comprimidos em duas semanas — com trens-bala silenciosos, hotéis de primeira e curadoria que abre portas fora do circuito de ônibus.",
    highlights: [
      { title: "Cidade Proibida ao amanhecer", story: "Entra-se pelo Portão Meridional às 8h30 quando o complexo abre — 980 edifícios, 8.700 salas, quatro séculos de dinastias Ming e Qing. Sobe-se ao Jingshan Park no morro em frente e vê-se do alto todos os telhados dourados alinhados no eixo cósmico norte-sul de Beijing. Um imperador viveu ali sem sair por 60 anos. Você entende por quê." },
      { title: "Grande Muralha em Jinshanling ou Mutianyu", story: "Não Badaling — lotada. Em Mutianyu (só 1h30 de Beijing), teleférico até torre 14, caminhada de 3km entre torres de vigia restauradas com vista de 360° sobre montanhas cobertas de floresta. Em Jinshanling, para trekkers, 10km de muralha semi-selvagem com trechos originais Ming, quase sozinho. Descida de tobogã no final." },
      { title: "Guerreiros de Terracota, Xi'an", story: "Descobertos em 1974 por um camponês cavando um poço. 8.000 soldados em tamanho real, cada rosto único, esculpidos há 2.200 anos para proteger o primeiro imperador Qin Shi Huang na eternidade. A escala do Fosso 1 — hangar do tamanho de um campo de futebol com fileiras infinitas de guerreiros — é uma das experiências mais impactantes que existe em arqueologia mundial." },
      { title: "Trem-bala Beijing → Xi'an → Shanghai", story: "5h30 a 350 km/h em silêncio absoluto sobre linha dedicada de alta velocidade. Poltronas amplas, tomadas, wi-fi. Vê-se a China rural passar pela janela — vilarejos de tijolo, campos de arroz, cidades novas emergindo do nada. É o Japão dos anos 80 acontecendo agora, em escala continental." },
      { title: "Shanghai: Bund, Pudong e French Concession", story: "Ao entardecer, caminha-se pelo Bund entre edifícios art déco dos anos 1920 e vê-se do outro lado do rio Huangpu a skyline futurista de Pudong acender: Shanghai Tower (632m, segunda maior do mundo), Jin Mao, Torre Pérola. À noite, tomar coquetel no bar do Peace Hotel com jazz band que toca desde 1980 e depois jantar dumplings de sopa (xiao long bao) num beco da French Concession." },
    ],
    beyondUsual: [
      "Jantar de Pato Laqueado em Da Dong, casa que reinventou o clássico Ming.",
      "Trecho de trekking exclusivo com pernoite em torre restaurada da Muralha.",
      "Cerimônia do chá gongfu com mestre de Chengdu na French Concession.",
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Não. Desde 2024, brasileiros têm isenção de visto para estadias turísticas até 30 dias. Passaporte válido por 6 meses após o retorno é obrigatório." },
      { q: "Quantos dias ficar?", a: "12 a 14 dias para cobrir Beijing (4), Xi'an (2), Shanghai (3) com folga para dia livre." },
      { q: "É seguro para brasileiros?", a: "Extremamente seguro — a China é um dos países com menor índice de crimes contra turistas. O maior desafio é a barreira linguística e a ausência de Google/WhatsApp (use VPN)." },
      { q: "Como funciona a internet?", a: "Google, WhatsApp, Instagram e Facebook são bloqueados. Contrate VPN antes de embarcar (Astrill, ExpressVPN) ou use e-SIM internacional que roteia fora da China." },
      { q: "Preciso de guia local?", a: "Fortemente recomendado. Poucos chineses falam inglês fluente, o mandarim é impossível de improvisar e sites/apps são em chinês. A Create Travel organiza guias em português ou espanhol em cada cidade." },
      { q: "Como criar roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    id: "asia-china-yunnan",
    continent: "Ásia",
    country: "China",
    region: "Yunnan (Lijiang, Shangri-La, Yuanyang)",
    slug: "asia/china/yunnan",
    name: "China Yunnan — a China que ninguém conta",
    bestTime: "Fev–Mar (arrozais de Yuanyang cheios de água refletindo o céu); Set–Nov (colheita e clima seco).",
    tags: ["cultura", "natureza", "fotografia", "trekking", "remoto", "expedicao"],
    imageAiPrompt: "Ultra realistic editorial photo of Yuanyang rice terraces in Yunnan at sunrise, mist between flooded terraces, cinematic golden hour, no people.",
    imageOverrideUrl: chinaYunnanImg,
    intro: "Yunnan é a China que a maioria dos brasileiros nem imagina existir: 25 etnias minoritárias, arrozais espelhados esculpidos há 1.300 anos pelos Hani, cidades antigas de madeira dos Naxi ao pé do Himalaia e a última fronteira do budismo tibetano em território chinês. Uma alternativa autoral ao circuito Beijing–Xi'an–Shanghai — mais lenta, mais fotogênica, muito menos turística.",
    highlights: [
      { title: "Arrozais de Yuanyang (UNESCO)", story: "Cinco horas de estrada ao sul de Kunming, montanhas inteiras esculpidas em terraços de arroz há 1.300 anos pelos Hani — patrimônio mundial UNESCO desde 2013. Ao amanhecer em fevereiro, quando os terraços estão cheios de água antes do plantio, cada nível reflete o céu rosa e dourado em espelhos que descem a montanha em curvas orgânicas. Uma das paisagens mais fotografadas por Sebastião Salgado, Michael Kenna e National Geographic." },
      { title: "Lijiang antiga (Naxi) ao pé do Himalaia", story: "Cidade de 800 anos, canais cortando ruas de pedra, casas de madeira dos Naxi (matriarcado com escrita pictográfica dongba, a última do mundo em uso). Ao fundo, a Montanha do Dragão de Jade (Yulong Xueshan, 5.596m) sempre coberta de neve. À noite, restaurantes tocam música naxi ancestral em instrumentos que remontam à dinastia Tang." },
      { title: "Shangri-La e mosteiros tibetanos", story: "A 3.200m de altitude, a cidade oficialmente rebatizada Shangri-La em 2001 é hoje o coração tibetano fora do Tibete. O Mosteiro Songzanlin, réplica do Palácio de Potala em Lhasa, abriga 700 monges lamas. Ao entardecer, gira-se a maior roda de oração do mundo (21m) enquanto tibetanos com túnicas grená circundam murmurando 'om mani padme hum'." },
      { title: "Garganta do Salto do Tigre", story: "Uma das gargantas mais profundas do mundo — 3.900m entre o cume e o rio Yangtzé fluindo lá embaixo. Trek de 2 dias pela trilha alta com pernoite em guesthouse na aldeia Naxi de Tina's, vista frontal das paredes verticais nevadas. Fisicamente exigente, cinematograficamente inesquecível." },
      { title: "Chá Pu'er nas montanhas de origem", story: "Yunnan é o berço mundial do chá — árvores selvagens de Camellia sinensis com mais de 1.700 anos ainda produzem folhas em Xishuangbanna e Menghai. Visita a plantações centenárias, degustação de pu'er envelhecido (chá fermentado que valoriza com o tempo como vinho) e almoço com família Bulang na aldeia produtora." },
    ],
    beyondUsual: [
      "Pernoite em guesthouse-boutique em Yuanyang com fotografia guiada no amanhecer.",
      "Trek privativo no Salto do Tigre com carregadores locais.",
      "Cerimônia matinal com monges no Mosteiro Songzanlin em Shangri-La.",
    ],
    stays: [],
    faq: [
      { q: "Yunnan combina com China clássica?", a: "Perfeitamente. Extensão de 7–9 dias a partir de Shanghai (voo 3h a Kunming). Muitos clientes fazem 14 dias clássico + 7 dias Yunnan como viagem definitiva à China." },
      { q: "Quantos dias para Yunnan?", a: "Mínimo 8 dias: Kunming (1), Yuanyang (2), Lijiang (2), Shangri-La (3). Ideal 10–12 dias incluindo Dali e Xishuangbanna." },
      { q: "Tem altitude?", a: "Sim. Shangri-La fica a 3.200m e alguns passos chegam a 4.500m. Chegue por Lijiang (2.400m) para aclimatação gradual. Evite se tiver contraindicação cardíaca." },
      { q: "É seguro?", a: "Sim, extremamente seguro. Apenas atenção redobrada com altitude e clima montanhês (variações grandes de temperatura no mesmo dia)." },
      { q: "Vou encontrar outros ocidentais?", a: "Pouquíssimos. Yunnan é destino de brasileiros zero — a maior parte dos turistas é chinesa doméstica. Guias em inglês/espanhol precisam ser reservados com antecedência." },
      { q: "Como criar roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    id: "asia-china-guizhou",
    continent: "Ásia",
    country: "China",
    region: "Guizhou (Miao & Dong)",
    slug: "asia/china/guizhou",
    name: "China Guizhou — aldeias Miao e Dong",
    bestTime: "Mar–Mai e Set–Nov (clima ameno e festivais étnicos); Nov (Ano Novo Miao com festa de touros).",
    tags: ["cultura", "fotografia", "remoto", "expedicao", "conservacao"],
    imageAiPrompt: "Ultra realistic photo of Miao ethnic village in Guizhou with wooden stilt houses on terraced hillsides, morning mist, karst mountains, no people.",
    imageOverrideUrl: chinaGuizhouImg,
    intro: "Guizhou é a província mais surpreendente da China — montanhas cársticas cobertas de florestas, 18 etnias minoritárias que ainda vivem em aldeias de madeira acessíveis por trilhas, mulheres Miao com toucas de prata de 3kg, torres de tambor Dong construídas sem um único prego. Zero turistas ocidentais, muita autenticidade, curadoria imprescindível.",
    highlights: [
      { title: "Aldeia Miao de Xijiang (Mil Famílias)", story: "A maior aldeia Miao do mundo — mil casas de madeira em estilo diaojiaolou (palafitas) empilhadas em anfiteatro natural na encosta. À noite, todas as luzes acendem simultaneamente como constelação. Mulheres Miao ainda usam trajes bordados à mão e toucas de prata pesando 3kg em cerimônias — cada peça é dote familiar passado por gerações." },
      { title: "Torres de tambor Dong de Zhaoxing", story: "Os Dong constroem torres de madeira de até 9 andares (drum towers) e pontes cobertas (wind-and-rain bridges) sem usar um único prego — só encaixes, técnica classificada patrimônio imaterial UNESCO. Zhaoxing tem cinco torres num único vilarejo. Ao entardecer, mulheres cantam polifonia dong (também UNESCO) — coros a capela em harmonias impossíveis que só existem ali." },
      { title: "Cachoeira Huangguoshu", story: "A maior cachoeira da Ásia — 78m de altura, 101m de largura. Anel de trilhas permite passar por trás da cortina d'água. Menos famosa que Iguaçu, escala similar, cenário cárstico único." },
      { title: "Festivais étnicos (Sisters' Meal, Lusheng)", story: "Guizhou tem mais de 400 festivais tradicionais por ano — um a cada dia em algum vilarejo. Sisters' Meal Festival dos Miao (abril) é o mais antigo festival de amor do mundo: mulheres oferecem bolinhos coloridos aos pretendentes, com fio de linha dentro (sim) ou espinho de pinheiro (não). Festival Lusheng (setembro) reúne aldeias inteiras dançando com flautas de bambu de 3m de comprimento." },
      { title: "Culinária Miao ácida e picante", story: "A cozinha Miao usa fermentação ácida como base — peixes de arroz criados nos próprios terraços cozidos em sopa azeda de tomate fermentado, arroz glutinoso colorido com folhas nativas em cinco cores para festivais, licor caseiro de arroz servido em chifre de búfalo pelas anfitriãs. Nada disso está em cardápio de restaurante chinês no exterior." },
    ],
    beyondUsual: [
      "Pernoite em guesthouse-família Miao em Xijiang, com jantar caseiro e canto polifônico.",
      "Encontro privativo com prateiro Miao em Kaili para ver forja tradicional.",
      "Combinação com Yunnan para uma expedição etnográfica de 15 dias pelo sudoeste chinês.",
    ],
    stays: [],
    faq: [
      { q: "Como chegar em Guizhou?", a: "Voo doméstico Shanghai/Beijing a Guiyang (2h30) ou trem-bala Guangzhou–Guiyang (4h). Guiyang é a base de partida para as aldeias, com traslado de 3–5h de carro." },
      { q: "É turístico?", a: "Praticamente nenhum turista ocidental. Alguns turistas chineses domésticos, mas muitas aldeias permanecem sem infraestrutura para estrangeiros — daí a importância de curadoria e guia falando inglês/espanhol." },
      { q: "Quantos dias?", a: "6 a 8 dias exclusivos, ou 5 dias como extensão do circuito clássico. Sugerimos combinar com Yunnan (15 dias total) para expedição etnográfica completa." },
      { q: "Que tipo de viajante gosta de Guizhou?", a: "Fotógrafos, antropólogos amadores, viajantes que já conhecem China clássica e querem ir mais fundo, casais buscando destinos sem redes sociais brasileiras marcando." },
      { q: "Tem hospedagem confortável?", a: "Sim, em Guiyang e Kaili há hotéis 4–5 estrelas internacionais. Nas aldeias, guesthouses charmosas com banheiro privativo e aquecimento (essencial em fev–mar). Não espere resort." },
      { q: "Como criar roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
  ...
  {
    id: "oriente-medio-jordania",
    continent: "Oriente Médio",
    country: "Jordânia",
    region: "Petra, Wadi Rum & Mar Morto",
    slug: "oriente-medio/jordania/petra-wadi-rum",
    name: "Jordânia (Petra & Wadi Rum)",
    bestTime: "Mar–Mai e Set–Nov (clima ameno, ideal para deserto e trilhas em Petra); evite Jul–Ago (calor extremo).",
    tags: ["cultura", "aventura", "fotografia", "expedicao", "roteiro-classico"],
    imageAiPrompt: "Ultra realistic editorial photo of Petra Treasury in Jordan at dawn, rose-red sandstone facade seen from the Siq canyon, warm golden light, cinematic no people, magazine travel cover.",
    imageOverrideUrl: jordaniaImg,
    intro: "Petra rosada esculpida no arenito há 2.000 anos, o silêncio marciano de Wadi Rum, a flutuação surreal do Mar Morto e a hospitalidade beduína genuína. A Jordânia é um dos destinos mais cinematográficos e seguros do Oriente Médio — cabendo em 8 a 10 dias com conforto absoluto.",
    highlights: [
      { title: "Petra e o Al-Khazneh ao amanhecer", story: "Entra-se pelo Siq às 6h — desfiladeiro estreito de 1,2 km entre paredões de 80m — caminhando no silêncio absoluto até a última curva revelar o Al-Khazneh, o Tesouro, esculpido em rosa há 2.000 anos pelos nabateus. Sem ônibus, sem multidão, apenas o beduíno acendendo fogueira ao lado. Um dos momentos mais fotografados do planeta merecidamente. O sítio inteiro tem 800 monumentos e exige dois dias completos para incluir a subida ao Monastério (Ad Deir), 800 degraus recompensados por outra fachada colossal quase intocada." },
      { title: "Petra iluminada por velas (Petra by Night)", story: "Três noites por semana, o Siq inteiro é iluminado por 1.500 velas em sacos de areia, do início ao Tesouro. Caminha-se em silêncio absoluto ao som de flauta bedu tocada ao vivo diante do Al-Khazneh, chá servido em copinhos de vidro. É pura magia — e experiência exclusiva no mundo." },
      { title: "Wadi Rum: acampar sob o céu do deserto vermelho", story: "3 horas ao sul de Petra, Wadi Rum é um deserto de arenito rosado onde Lawrence da Arábia filmou e onde Ridley Scott gravou Marte em 'Perdido em Marte'. Cruza-se de jipe 4x4 com beduíno Zalabia entre arcos naturais, gravuras rupestres nabateias e monólitos rosa. À noite, jantar zarb (cordeiro cozido sob a areia por 4h) e pernoite em bubble tent transparente para dormir literalmente vendo a Via Láctea rasgando o céu — um dos melhores céus do mundo para astrofotografia." },
      { title: "Mar Morto (lado jordaniano) — resorts com vista", story: "O mesmo Mar Morto de Israel, mas do lado jordaniano os resorts são mais novos, mais luxuosos e menos lotados. Kempinski Ishtar e Mövenpick oferecem piscinas em cascata descendo até o mar, spas com lama negra terapêutica e vista frontal para as montanhas de Israel do outro lado. Flutua-se sem esforço na água mais salgada do mundo (33%), pinga-se para baixo lendo revista." },
      { title: "Jerash — Roma no Oriente", story: "45 min ao norte de Amã, Jerash é a Pompeia do Oriente Médio — cidade greco-romana quase intacta com anfiteatro para 3.000 pessoas onde ainda acontecem concertos, arco de Adriano de 21m, colunata oval única no mundo romano com 160 colunas jônicas de 15m. Menos famosa que Petra, arqueologicamente talvez mais impressionante." },
    ],
    beyondUsual: [
      "Pernoite em bubble tent transparente em Wadi Rum com astrofotografia guiada.",
      "Petra by Night com jantar bedu privativo dentro do sítio.",
      "Caminhada pelo Wadi Musa e trilha secreta 'back door' até o Monastério.",
    ],
    stays: [],
    faq: [
      { q: "É seguro viajar para a Jordânia?", a: "Sim. A Jordânia é considerada um dos países mais seguros do Oriente Médio, com forte tradição de hospitalidade e políticas turísticas rigorosas. Turistas raramente relatam qualquer incidente." },
      { q: "Brasileiros precisam de visto?", a: "Sim, mas é obtido na chegada por US$ 60. Alternativamente, o Jordan Pass (US$ 100–110) já inclui visto + entradas para 40 sítios incluindo Petra por 3 dias — vale muito a pena." },
      { q: "Quantos dias ficar?", a: "8 a 10 dias ideais: Amã (1), Jerash + Castelos (1), Mar Morto (1), Petra (2), Wadi Rum (2), Aqaba/Mar Vermelho (1). Extensão de mais 4 dias combinando com Israel funciona muito bem." },
      { q: "Combina com Israel ou Egito?", a: "Sim. A fronteira terrestre com Israel (King Hussein Bridge) e com Egito (Aqaba–Taba) permite roteiros combinados. Muitos clientes fazem 14 dias Israel + Jordânia." },
      { q: "É acessível para crianças?", a: "Sim, mas Petra exige caminhada de 4–6 km/dia com desníveis. Para famílias, oferecemos burros ou charretes entre trechos. Wadi Rum é adorado pelas crianças." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    id: "asia-coreia-do-sul",
    continent: "Ásia",
    country: "Coreia do Sul",
    region: "Seul, Busan, Jeju & DMZ",
    slug: "asia/coreia-do-sul/seul-busan",
    name: "Coreia do Sul",
    bestTime: "Abr (cerejeiras), Out (folhagens vermelhas de outono), Dez–Fev (esqui em PyeongChang). Evite Jul–Ago (calor úmido e chuva de monção).",
    tags: ["cultura", "gastronomia", "fotografia", "cidade", "familia"],
    imageAiPrompt: "Ultra realistic editorial photo of Seoul with Bukchon Hanok Village traditional Korean rooftops in foreground and futuristic N Seoul Tower skyline behind, cherry blossoms, twilight, no people, magazine travel cover.",
    imageOverrideUrl: coreiaDoSulImg,
    intro: "K-pop, K-drama, kimchi e templos de mil anos: a Coreia do Sul é o destino asiático que virou trend mundial — e o Brasil finalmente descobriu. Seul cosmopolita, palácios Joseon, DMZ com a Coreia do Norte à vista, Busan à beira-mar, ilha vulcânica de Jeju e uma cena gastronômica que ganhou mais estrelas Michelin por metro quadrado que quase qualquer capital.",
    highlights: [
      { title: "Palácios de Seul e Bukchon Hanok Village", story: "Gyeongbokgung, o Grande Palácio Joseon (1395), oferece cerimônia diária de troca da guarda com trajes coloridos e tambores; alugar hanbok (traje tradicional) por 3h e passear pelos jardins é ritual obrigatório. Ao lado, Bukchon é o único bairro histórico Joseon preservado — 900 casas hanok tradicionais em labirinto de vielas entre dois palácios, com vista para a Seoul Tower ao fundo. Amanhecer aqui é foto de capa." },
      { title: "DMZ — a fronteira mais tensa do mundo", story: "Uma hora ao norte de Seul, atravessa-se a Zona Desmilitarizada que separa as duas Coreias desde 1953 — 4 km de largura, minas terrestres, arame farpado, tigres selvagens (a natureza voltou porque humanos não podem entrar). No Panmunjom, entra-se em salas de conferência azuis que cruzam a linha divisória: um passo e você está tecnicamente na Coreia do Norte. Guia militar americano ou coreano. Uma das visitas geopolíticas mais impactantes do planeta." },
      { title: "Gastronomia coreana autêntica", story: "Korean BBQ mesa a mesa em Gangnam com samgyeopsal (barriga de porco) e wagyu grelhados sobre carvão, banchan (10–20 acompanhamentos gratuitos) e soju gelado; bibimbap de pedra quente onde o arroz fica crocante no fundo; kimchi de 200 variedades regionais fermentado por avós há décadas; noite em pojangmacha (barraca de rua com toldo laranja) comendo tteokbokki (bolinhos apimentados) e sundae (linguiça de sangue). Fecha-se em karaoke privativo (noraebang) até as 4h." },
      { title: "Busan e o litoral sul", story: "Segunda cidade do país, à beira do Mar do Japão. Praia de Haeundae com edifícios de 80 andares no fundo, mercado de peixes de Jagalchi (o maior da Ásia) onde escolhe-se peixe vivo do tanque e sobe-se para o restaurante do 2º andar comê-lo em sashimi 15 min depois. Vila Gamcheon Culture, favela colorida no morro que virou galeria de arte urbana — o 'Machu Picchu de Busan'." },
      { title: "Ilha de Jeju e Jeju Olle Trails", story: "Ilha vulcânica ao sul do país, patrimônio UNESCO natural — cratera Hallasan (1.947m, ponto mais alto da Coreia), túneis de lava, praias de areia preta, cachoeiras despencando no mar. As 26 Olle Trails cobrem 425 km costeiros com painéis interpretativos em coreano, japonês e inglês; as haenyeo (mergulhadoras avós de 70+ anos, tradição matriarcal UNESCO) ainda pescam pulpo e abalone livres, sem tanque de oxigênio." },
    ],
    beyondUsual: [
      "Templo-stay em mosteiro budista Jogyesa com meditação e refeição vegetariana silenciosa.",
      "Aula privativa de culinária coreana com chef estrela Michelin em Seul.",
      "K-pop experience em estúdio real (dance class, hair-makeup, MV shoot).",
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Sim, K-ETA (autorização eletrônica online) por US$ 10 — obtenção em 72h antes de embarcar. Passaporte válido por 6 meses obrigatório." },
      { q: "Quantos dias ficar?", a: "10 a 14 dias: Seul (4–5), DMZ (1), Busan (2), Jeju (3), Gyeongju/Andong (2). Extensão de 5 dias para combinar com Japão funciona perfeitamente." },
      { q: "É difícil sem falar coreano?", a: "Manejável. Placas em inglês nas grandes cidades e transporte. Fora de Seul e Busan, guias em português/espanhol são essenciais — reservamos com antecedência." },
      { q: "Melhor época para cerejeiras?", a: "Primeira semana de abril em Seul (2–3 semanas antes que Kyoto). Yeouido e Jinhae são os epicentros do hanami coreano." },
      { q: "Combina com Japão?", a: "Perfeitamente. Voo Seul–Tokyo em 2h30, ou ferry Busan–Fukuoka em 3h. Muitos clientes fazem 20 dias combinando Coreia + Japão." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    id: "oriente-medio-emirados",
    continent: "Oriente Médio",
    country: "Emirados Árabes Unidos",
    region: "Dubai & Abu Dhabi",
    slug: "oriente-medio/emirados-arabes/dubai-abu-dhabi",
    name: "Emirados Árabes (Dubai & Abu Dhabi)",
    bestTime: "Nov–Mar (clima ameno, 20–28°C, ideal para deserto e praia). Evite Jun–Set (45°C+, umidade sufocante). Ramadã altera horários.",
    tags: ["cidade", "praia", "gastronomia", "familia", "lua-de-mel", "luxo"],
    imageAiPrompt: "Ultra realistic editorial photo of Dubai skyline at golden hour with Burj Khalifa and Sheikh Zayed Grand Mosque domes in foreground, desert dunes fading into modern city, cinematic warm light, no people, magazine travel cover.",
    imageOverrideUrl: emiradosImg,
    intro: "Do Burj Khalifa (o edifício mais alto do mundo, 828m) às dunas ondulantes do deserto vermelho, dos mercados de especiarias do velho Dubai à Mesquita Sheikh Zayed toda em mármore branco e ouro — os Emirados são a escala e a hospitalidade árabe elevadas ao superlativo. Perfeito como stopover em voos para Ásia/África, como destino em si (7–10 dias) ou como conjugado com Maldivas.",
    highlights: [
      { title: "Burj Khalifa e Dubai Mall", story: "Sobe-se 828m em 60 segundos no elevador mais rápido do mundo até o observatório At the Top no 148º andar — Dubai vira maquete lá embaixo, o Golfo Pérsico se estende ao infinito, aviões passam por baixo dos pés. Ao anoitecer, do Burj Park abaixo, assiste-se ao Dubai Fountain — 275m de jatos coreografados até 150m de altura ao som de música árabe e ópera, gratuito a cada 30 min. Ao lado, o Dubai Mall (o maior shopping do mundo) com aquário de 10 milhões de litros e pista de patinação olímpica indoor." },
      { title: "Safari no deserto e jantar bedu", story: "Sai-se de 4x4 Land Cruiser às 15h em direção às dunas vermelhas de Al Awir. Dune bashing (uma hora subindo e descendo dunas de 100m em velocidade — mais adrenalina que qualquer parque), sandboard, camelo ao pôr do sol vermelho absoluto, chegada ao camp bedu com jantar de zarb (cordeiro cozido sob a areia), narguilé, henna, dança do ventre e falcoaria. Retorno à meia-noite. Um dos programas obrigatórios do Golfo." },
      { title: "Mesquita Sheikh Zayed em Abu Dhabi", story: "Uma hora de Dubai, a maior mesquita dos Emirados é um dos edifícios religiosos mais belos do planeta — 82 domos de mármore branco de Macedônia, 1.096 colunas com incrustações de lápis-lazúli e madrepérola, maior lustre de cristal Swarovski do mundo (12 toneladas), maior tapete persa artesanal (5.700 m² tecido por 1.200 mulheres iranianas por 2 anos). Entrada gratuita para todos os credos, com abaya emprestado para mulheres. Ao anoitecer, iluminação branco-lunar acompanha as fases da lua." },
      { title: "Old Dubai — Al Fahidi, Gold Souk e Spice Souk", story: "Do outro lado do Dubai Creek, o velho Dubai preserva o passado bedu de pescadores de pérolas. Al Fahidi Historic District tem casas de coral branco com torres de vento (barajeel — ar condicionado natural árabe medieval), agora galerias e cafés árabes. Atravessa-se o creek por 1 dirham em abras (barcos de madeira) até o Gold Souk (o maior mercado de ouro do mundo, 300 lojas, joias por peso) e o Spice Souk (montanhas de açafrão, cardamomo, pétalas de rosa, especiarias exóticas)." },
      { title: "Palm Jumeirah e resorts icônicos", story: "A ilha artificial em formato de palmeira vista de helicóptero é imperdível — engenharia impossível a olho nu. Nela, resorts icônicos: Atlantis The Palm (com Aquaventure, o maior parque aquático de Oriente Médio), One&Only The Palm (mais discreto, adults-only), Anantara The Palm (bangalôs sobre a água ao estilo Maldivas, mais barato que Maldivas). Do Burj Al Arab (o vela) toma-se afternoon tea no Skyview Bar a 200m de altura." },
    ],
    beyondUsual: [
      "Voo em balão sobre o deserto de Al Marmoom ao amanhecer com café da manhã bedu.",
      "Yate privativo pelo Palm Jumeirah e Marina ao pôr do sol com chef a bordo.",
      "Almoço com falcoeiro real na fazenda de falcões da família Al Maktoum.",
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Não. Visto na chegada gratuito por 90 dias em qualquer aeroporto dos Emirados. Passaporte com validade mínima de 6 meses obrigatório." },
      { q: "É seguro?", a: "Extremamente seguro. Dubai e Abu Dhabi têm alguns dos menores índices de criminalidade do mundo. Câmeras em toda parte, polícia visível, tolerância zero." },
      { q: "É muito caro?", a: "Depende. Hotelaria varia de R$ 300 (bons 4 estrelas em Deira) a R$ 15.000/noite (Burj Al Arab). Restaurantes idem. Transporte por Uber/Careem é acessível. Metrô é impecável e barato." },
      { q: "É apropriado para mulheres viajando sozinhas?", a: "Sim, um dos destinos mais seguros do Oriente Médio para mulheres. Vestimenta recomendada é discreta em áreas públicas (ombros cobertos), mas biquíni é liberado em praias privativas de hotel. Nas mesquitas, abaya é obrigatório e emprestado." },
      { q: "Combina com Maldivas ou Seychelles?", a: "Sim, é o conjugado clássico. Voos diretos Dubai–Malé em 4h. Recomendamos 4 dias Dubai + 6 dias Maldivas como lua-de-mel perfeita." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    ...
    slug: "asia/singapura/marina-bay",
    name: "Singapura",
    bestTime: "Fev–Abr (menos chuva). Clima equatorial estável 26–31°C o ano inteiro. Evite Nov–Jan (monção norte).",
    tags: ["cidade", "gastronomia", "familia", "cultura", "lua-de-mel"],
    imageAiPrompt: "Ultra realistic editorial photo of Singapore Marina Bay Sands and Gardens by the Bay Supertrees at blue hour, illuminated futuristic architecture reflected in water, lush tropical greenery, no people, magazine travel cover.",
    imageOverrideUrl: singapuraImg,
    intro: "A cidade-estado mais eficiente do planeta comprime, em 728 km², arranha-céus futuristas, floresta tropical, quatro culturas em harmonia (chinesa, malaia, indiana, ocidental) e uma cena gastronômica com dois hawker centers UNESCO. Perfeita como stopover em voos para Bali/Austrália, como destino independente (4–5 dias) ou como base para explorar o Sudeste Asiático.",
    highlights: [
      { title: "Marina Bay Sands e Gardens by the Bay", story: "O Marina Bay Sands, três torres unidas por um barco de 340m no topo (SkyPark com a maior piscina infinita elevada do mundo — 150m acima do chão), é o ícone que definiu a Singapura contemporânea. Ao lado, os Gardens by the Bay têm 18 Supertrees de 25–50m cobertas por 158.000 plantas verticais que se acendem à noite em espetáculo sincronizado 'Garden Rhapsody' (gratuito, 19h45 e 20h45). Nas cúpulas Cloud Forest e Flower Dome, replicam-se climas montanhoso e mediterrâneo dentro de estufas gigantes." },
      { title: "Hawker centers UNESCO (comida de rua premiada)", story: "Em 2020, a UNESCO declarou a cultura hawker de Singapura patrimônio imaterial mundial — os primeiros centros gastronômicos populares a receber a honra. Em Maxwell, Lau Pa Sat, Chinatown Complex ou Tekka, dezenas de barracas de família (algumas há 60 anos) servem chicken rice hainanês (o prato nacional), chili crab, laksa, char kway teow, satay e roti prata por US$ 3–6. Duas barracas ganharam estrela Michelin (Hawker Chan e Hill Street Tai Hwa Pork Noodle) — as refeições Michelin mais baratas do mundo." },
      { title: "Chinatown, Little India e Kampong Glam", story: "Três bairros étnicos em 15 min de metrô uns dos outros. Chinatown com templos taoístas (Thian Hock Keng, 1839, sem um único prego), medicina tradicional chinesa e comida de família. Little India com o templo Sri Veeramakaliamman dourado, curry banana leaf servido em folha de bananeira, saris de seda e mercado 24h de Tekka. Kampong Glam com a Mesquita do Sultão dourada, ruas árabes de Arab Street e Haji Lane com street art, bares de rooftop e boutiques hipster." },
      { title: "Sentosa e Universal Studios Singapore", story: "Ilha ao sul acessível por monorail, teleférico ou ponte — combina praias artificiais, resorts (Capella Singapore, um dos melhores do mundo), Universal Studios Singapore (versão compacta, ideal com crianças 8+), SEA Aquarium (um dos maiores do mundo), Adventure Cove Waterpark. À noite, Wings of Time é show de fogos, água e laser sobre o mar." },
      { title: "Singapore Airlines e Changi Airport", story: "O Changi Airport foi eleito melhor aeroporto do mundo por 12 anos consecutivos. Tem cachoeira interior de 40m (Rain Vortex, a maior indoor do planeta), jardins de borboletas, piscina no terraço, cinema 24h e labirinto de espelhos — muitos viajantes chegam 6h antes por diversão. A Singapore Airlines é referência mundial em serviço; voar com ela via Changi já é parte da experiência." },
    ],
    beyondUsual: [
      "Jantar suspenso Cé La Vi no topo do Marina Bay Sands ao pôr do sol.",
      "Tour privativo de hawker centers com food writer local (comida em 4 barracas + história).",
      "Passeio de bumboat pelo Singapore River com narrativa histórica ao entardecer.",
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Não. Isento por 30 dias para turismo. Passaporte com validade mínima de 6 meses obrigatório. Cartão de embarque digital SG Arrival Card gratuito 72h antes." },
      { q: "Quantos dias ficar?", a: "4 a 5 dias suficientes para cobrir a cidade com calma. Como stopover, 2–3 dias funcionam. Combina perfeitamente com Bali (voo 2h30) ou Sydney (voo 8h)." },
      { q: "É muito caro?", a: "Hotelaria e álcool são caros (comparável a Nova York). Alimentação em hawker centers é acessível. Transporte público impecável e barato. No fim, custo médio a alto — mas cada dólar entrega experiência." },
      { q: "É bom para crianças?", a: "Um dos melhores destinos asiáticos para famílias: Universal Studios, SEA Aquarium, Gardens by the Bay, zoo noturno (Night Safari), praias artificiais em Sentosa. Seguro absoluto, limpo, sem barreira linguística." },
      { q: "É seguro?", a: "Um dos países mais seguros do mundo — pode-se deixar celular sobre a mesa e ninguém tocará. Tolerância zero com pequenos delitos. Atenção apenas às leis rígidas (multas por chicletes, cigarros em locais errados, jogar lixo)." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
  ...
  },
  {
    ...
    continent: "Ásia",
    country: "Butão",
    region: "Paro, Thimphu, Punakha, Bumthang & Gangtey",
    slug: "asia/butao/vales-himalaicos",
    name: "Butão (Vales do Himalaia)",
    bestTime: "Out–início de Mar (seca, céus limpos, ideal para trekking e festivais Tsechu); Mar–Jun (cool season, floração de rododendros). Evite Jul–Set (monção nas regiões central e leste).",
    tags: ["cultura", "trekking", "bem-estar", "montanha", "conservacao", "fotografia"],
    imageAiPrompt: "Ultra realistic editorial photo of Bhutan Tiger's Nest Monastery clinging to Himalayan cliff at dawn, mist rising through pine forest, snow peaks behind, cinematic warm light, no people, magazine travel cover.",
    imageOverrideUrl: butaoImg,
    intro: "O único país do mundo cuja política oficial é a Felicidade Interna Bruta, o único carbono-negativo do planeta e o único reino budista himalaico ainda intacto. O Butão opera política de 'high value, low impact' — cada visitante paga taxa diária de sustentabilidade que financia educação e saúde gratuitas para os butaneses. O resultado: vales silenciosos, dzongs (fortalezas-mosteiro) sobre rios turquesa, monges pintando thangkas há 400 anos e a hospitalidade genuína de um povo profundamente feliz.",
    highlights: [
      { title: "Tiger's Nest (Taktsang) — o mosteiro do ninho do tigre", story: "Suspenso a 900m acima do vale de Paro, agarrado à parede de granito por raízes de pinheiro, o Paro Taktsang foi construído em 1692 no local onde Guru Rinpoche teria voado do Tibete montado numa tigresa no século VIII. A subida de 3h começa em floresta de pinheiros com bandeiras de oração, atravessa cachoeira sagrada e culmina no complexo de quatro templos entre nuvens. Um dos sítios espirituais mais fotografados da Ásia — e o momento que define a viagem." },
      { title: "Punakha Dzong — a fortaleza sobre dois rios", story: "Construído em 1637 na confluência do Pho Chhu (rio macho) e Mo Chhu (rio fêmea), o Punakha Dzong é o dzong mais bonito do Butão — três pátios brancos com pintura de ouro, madeira entalhada em glicínias, monges de manto vermelho atravessando pontes cantilever. Sede do inverno do clero, palco do casamento real de 2011. Ao anoitecer, com montanhas rosadas atrás e rios turquesa espelhando, é cenário de fábula." },
      { title: "Vale de Bumthang — o coração espiritual do Butão", story: "Quatro vales isolados no centro do país, considerados a Suíça asiática e o berço religioso do reino. Jakar Dzong sobre morro dominando o vale, Kurjey Lhakhang com impressão do corpo de Guru Rinpoche em rocha, Jambay Lhakhang do século VII (um dos 108 templos construídos em uma noite pelo rei tibetano Songtsen Gampo). Fazendas familiares fervendo cerveja de trigo (ara), teares de brocado de seda, monastérios remotos alcançáveis só a pé." },
      { title: "Gangtey e o vale de Phobjikha — os grous de pescoço preto", story: "Vale glacial em U a 3.000m, sem eletricidade até 2010 para não perturbar as rotas migratórias dos raros grous de pescoço preto que voam do Tibete em outubro e ficam até fevereiro. Gangtey Goemba, monastério de 400 anos no morro central, celebra o festival Tshechu do Crane com máscaras de grou. Caminhadas planas pelo vale entre casas de fazenda de pedra e riachos glaciais — o Butão mais bucólico." },
      { title: "Thimphu — a capital sem semáforos", story: "Única capital do mundo sem semáforos (um policial com luvas brancas dirige o único cruzamento movimentado). Buddha Dordenma dourado de 51m dominando o vale, Tashichho Dzong sede do governo e do rei, mercado semanal de vegetais orgânicos, Instituto Zorig Chusum onde jovens aprendem as 13 artes tradicionais butanesas (pintura de thangka, escultura em madeira, bordado de ouro), e a Escola Nacional de Arqueiros — arco e flecha é esporte nacional, praticado com bambu e cerveja em festas de rua." },
      { title: "Haa Valley — o vale que abriu ao turismo em 2002", story: "Vale isolado a oeste de Paro, aberto ao turismo estrangeiro há apenas duas décadas — ainda profundamente rural, com farmhouses tradicionais de 3 andares (animais embaixo, família em cima, altar no topo). Almoço em casa de fazenda com red rice, ema datshi (pimenta com queijo — o prato nacional), suja (chá de manteiga de iaque), e depois trilha até os templos gêmeos brancos e negros (Lhakhang Karpo e Nagpo)." },
    ],
    beyondUsual: [
      { title: "Meditação privada com monge em templo particular de Lama Serpo", story: "Acesso exclusivo ao santuário privado de Lama Serpo em Punakha — retiro particular com estátuas raras de Buda, Tara Branca e Guru Rinpoche, onde estudantes fazem retiros de 3 anos. Sessão de meditação guiada por instrutor experiente, no silêncio absoluto entre pinturas budistas centenárias." },
      { title: "Cerimônia de acender lâmpadas de manteiga em Tango Monastery", story: "Após trilha de 1h até Tango e Cheri, mosteiros ao norte de Thimphu, participa-se do ritual de oferecer lâmpadas de manteiga de iaque — cada lâmpada simboliza sabedoria e dispersão da escuridão, dedicada a entes queridos vivos ou falecidos. Uma das cerimônias mais tocantes do budismo Vajrayana." },
      { title: "Aula de arqueria butanesa em Paro Dzongkhag", story: "Aula privada no campo oficial de arqueria de Paro, com marksmen locais que acertam alvos a 145m (regulamento internacional é 70m). Arcos de bambu tradicional ou carbono moderno. Termina com cerveja ara e cantos de vitória — parte inseparável de qualquer celebração butanesa." },
      { title: "Festival Tsechu — mascarada sagrada de 3 dias", story: "Se calhar de sua viagem coincidir com um Tsechu (Paro em março-abril, Thimphu em setembro, Bumthang em outubro), presenciar dias inteiros de dança mascarada Cham nos pátios do dzong é experiência única. Máscaras de divindades, cores explosivas, milhares de butaneses em trajes tradicionais gho e kira, purificação espiritual coletiva." },
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Sim. O visto é organizado pela operadora local butanesa (Trails of Indochina, nosso parceiro) junto ao Tourism Council of Bhutan. Não é obtido em consulado — sai automaticamente com a reserva do roteiro. Passaporte válido por 6 meses." },
      { q: "É verdade que precisa pagar taxa diária?", a: "Sim. O Butão cobra a Sustainable Development Fee de US$ 100/pessoa/dia (US$ 50 para crianças), destinada a educação, saúde e conservação florestal. É por isso que o país mantém turismo baixo e alta qualidade. Não inclui hospedagem, transporte ou guia — que somam separadamente." },
      { q: "Preciso de guia obrigatório?", a: "Sim, o Butão exige guia licenciado e motorista para todo turista estrangeiro em todas as regiões (exceto Paro e Thimphu urbanas). Isso garante experiência guiada, segurança e apoio à economia local." },
      { q: "Quantos dias ficar?", a: "8 a 12 dias ideais: Paro (2, incluindo Tiger's Nest), Thimphu (2), Punakha (2), Gangtey (2), Bumthang (2 se possível). Roteiros de 6 dias cobrem só Paro-Thimphu-Punakha; 14 dias permitem extensão até o leste (Trashigang) para os mais raros." },
      { q: "Combina com Nepal ou Índia?", a: "Sim. Voos diretos Paro–Kathmandu (Druk Air, 1h30) e Paro–Delhi (2h). O combinado clássico é 14 dias Nepal + Butão (Everest views + felicidade himalaica) ou 12 dias Butão + Norte da Índia (Darjeeling/Sikkim/Butão)." },
      { q: "É difícil fisicamente?", a: "Moderado. Tiger's Nest exige 5h de caminhada com desnível de 600m (opção de cavalo para metade). Altitudes entre 2.200m (Paro) e 3.100m (Gangtey) causam soroche leve em alguns dias iniciais. Passeios pela cidade são planos." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    ...
    continent: "Ásia",
    country: "Hong Kong",
    region: "Ilha de Hong Kong, Kowloon & Outlying Islands",
    slug: "asia/hong-kong/victoria-harbour",
    name: "Hong Kong",
    bestTime: "Out–Dez (frio seco, céu azul, ideal para caminhadas e vistas do Peak). Evite Jun–Set (tufões, calor úmido). Janeiro–Fevereiro tem o Ano Novo Chinês com fogos épicos sobre a baía.",
    tags: ["cidade", "gastronomia", "cultura", "familia", "fotografia", "cidade"],
    imageAiPrompt: "Ultra realistic editorial photo of Hong Kong Victoria Harbour skyline at blue hour from Victoria Peak, illuminated skyscrapers, red-sail junk boat in foreground, mountains framing bay, cinematic, no people, magazine travel cover.",
    imageOverrideUrl: hongKongImg,
    intro: "Uma das metrópoles mais densas e verticais do planeta, encravada entre montanhas subtropicais e uma das baías mais fotogênicas do mundo. Hong Kong é a fusão do capitalismo asiático em turbo com o Feng Shui milenar, do dim sum de rua com estrela Michelin ao rooftop do 118º andar. Perfeito como stopover em voos para Ásia/Oceania (3–4 dias) ou como destino independente (5–7 dias) explorando também as ilhas remotas.",
    highlights: [
      { title: "Victoria Peak e o skyline mais icônico da Ásia", story: "Sobe-se pelo Peak Tram (bonde vertical de 1888 com inclinação de 27°) até 552m de altitude, onde o Sky Terrace 428 abre a vista mais fotografada de Hong Kong — dois mil arranha-céus se comprimindo entre montanhas verdes e o Victoria Harbour azul, ferries cruzando lentamente, aviões pousando na antiga Kai Tak visíveis à noite. Ao pôr do sol, o skyline se acende arranha-céu por arranha-céu numa sinfonia elétrica. Às 20h, o Symphony of Lights coreografa laser e projeção em 40 edifícios ao som de música — o maior show permanente de luz e som do mundo (Guinness)." },
      { title: "Star Ferry e travessia do Victoria Harbour", story: "Por HK$ 5 (cerca de R$ 3), o ferry de convés de madeira de 1888 atravessa em 8 min do Central (Hong Kong Island) até Tsim Sha Tsui (Kowloon) — a travessia de balsa mais barata e cinematográfica do mundo. Do convés superior, o skyline gira como panorâmica de cinema. Do outro lado, a Avenue of Stars com estátua de Bruce Lee e prints das mãos de Jackie Chan, John Woo e Wong Kar-wai — a Hollywood asiática homenageada à beira-mar." },
      { title: "Dim sum e cha chaan teng — a comida de rua com Michelin", story: "Do dim sum matinal em bondes centenários (Tim Ho Wan, o restaurante Michelin mais barato do mundo — dim sum por HK$ 30) ao roast goose de Yat Lok (também Michelin), passando pelo lo mai gai (frango envolto em folha de lótus), char siu bao (pão recheado de porco), pineapple bun com manteiga fria de cha chaan teng (cafés locais de estilo britânico-hong-konguese). À noite, Temple Street Night Market com hot pot, curry fish balls, cerveja gelada e vidente do futuro. Hong Kong tem 78 estrelas Michelin — a densidade mais alta da Ásia depois de Tóquio." },
      { title: "Big Buddha em Lantau Island", story: "Bonde suspenso Ngong Ping 360 sobe 5,7 km sobre a floresta subtropical até o platô de Ngong Ping, onde o Tian Tan Buddha de bronze de 34m senta em pose de meditação desde 1993 — o maior Buda sentado ao ar livre do mundo. Sobem-se 268 degraus para tocar seus pés. Ao lado, o Monastério Po Lin serve refeição vegetariana budista com abade. Complemento perfeito: teleférico até Tai O, vila de pescadores palafíticos na costa oeste de Lantau, ainda com casas sobre estacas de bambu e pescadores de peixe seco." },
      { title: "Sai Kung e o Hong Kong Geopark — a Hong Kong que ninguém conhece", story: "40% do território de Hong Kong é parque nacional protegido. A leste, Sai Kung (a 'quintal de Hong Kong') tem trilhas costeiras entre falésias hexagonais de riolito (patrimônio UNESCO Global Geopark), praias paradisíacas de areia branca alcançáveis só por barco (Sharp Island, Long Ke Wan), e o restaurante de peixe fresco da vila onde escolhe-se do tanque e come-se em 20 min. Um dia lá e Hong Kong deixa de ser só arranha-céu." },
    ],
    beyondUsual: [
      { title: "Junk boat privativo pelo Victoria Harbour ao pôr do sol", story: "Fretar um junk tradicional de vela vermelha (Aqua Luna ou Dukling) para atravessar o Victoria Harbour sob a Symphony of Lights com bar aberto e chef a bordo. A vista do skyline do meio da baía é impossível de replicar de terra." },
      { title: "Helicóptero VIP sobre a Ilha de Hong Kong e o Big Buddha", story: "Voo privativo de 20–45 min do topo do Peninsula Hotel, sobrevoando o Victoria Harbour, Central skyline, Repulse Bay, Stanley e (na rota longa) o Big Buddha em Lantau. A única forma de ver a densidade absoluta de Hong Kong de cima." },
      { title: "Tea master workshop em Sheung Wan", story: "Aula privada com mestre de chá em casa de chá centenária de Sheung Wan (bairro antigo colonial) — cerimônia gongfu, degustação de 6 chás oolong e pu'er raros, história das rotas de chá cantonesas. Também aprende-se a ler as folhas na xícara para o futuro." },
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Não. Turismo de até 90 dias sem visto. Passaporte com validade mínima de 6 meses." },
      { q: "Quantos dias ficar?", a: "3 a 5 dias para o essencial urbano (Peak, Star Ferry, dim sum, Big Buddha). 7 dias permitem incluir Sai Kung, Lantau completa e day trip a Macau (1h de ferry, cassinos, comida macaense-portuguesa)." },
      { q: "Combina com China ou Japão?", a: "Perfeitamente. Trem de alta velocidade Hong Kong–Guangzhou em 48 min, Hong Kong–Shanghai em 8h, ou Beijing overnight. Voos Hong Kong–Tokyo em 4h. É o hub asiático por excelência." },
      { q: "É seguro?", a: "Extremamente seguro. Uma das menores taxas de criminalidade da Ásia. Metrô impecável até 1h da manhã. Sinalização em inglês em toda parte." },
      { q: "É muito caro?", a: "Hospedagem sim (5 estrelas de R$ 2.500 a R$ 12.000/noite). Comida e transporte muito acessíveis (dim sum por R$ 30, metrô por R$ 5). Compras variam — Central é premium, Mongkok é popular." },
      { q: "É bom para famílias?", a: "Excelente. Disneyland Hong Kong, Ocean Park (parque temático marinho + zoo panda), teleférico Big Buddha, ferry, montanhas e praias. Crianças adoram." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    ...
    continent: "Ásia",
    country: "Malásia",
    region: "Kuala Lumpur, Penang, Melaka, Langkawi & Bornéu",
    slug: "asia/malasia/kl-penang-borneo",
    name: "Malásia (KL, Penang & Bornéu)",
    bestTime: "Mar–Set (seca na costa oeste — KL, Penang, Langkawi, Melaka). Jun–Set melhor para Bornéu (Sabah). Evite Nov–Fev no leste (monção). Ano todo é quente e úmido — não há inverno.",
    tags: ["cultura", "gastronomia", "praia", "familia", "conservacao", "safari"],
    imageAiPrompt: "Ultra realistic editorial photo of Malaysia George Town Penang heritage street with rickshaw and Petronas Towers Kuala Lumpur skyline blended in golden hour, tropical, no people, magazine travel cover.",
    imageOverrideUrl: malasiaImg,
    intro: "Truly Asia, como diz a campanha oficial — e é. Malásia comprime, em dois territórios separados pelo Mar da China Meridional, quatro culturas em harmonia (malaia, chinesa, indiana, indígena), duas cidades UNESCO (George Town e Melaka), a floresta tropical mais antiga do mundo (Taman Negara, 130 milhões de anos), orangotangos selvagens em Bornéu e uma das melhores gastronomias de rua do planeta. Perfeita como destino independente (10–14 dias) ou como conjugado com Singapura/Tailândia.",
    highlights: [
      { title: "Kuala Lumpur — Petronas, Batu Caves e street food", story: "As Petronas Twin Towers (452m, as torres gêmeas mais altas do mundo) definiram o skyline de KL em 1998. Sobe-se ao Skybridge do 41º andar e ao observatório do 86º ao pôr do sol, com o KL Tower ao lado e o Bukit Bintang embaixo. A 30 min do centro, Batu Caves — templo hindu dentro de caverna calcária de 400 milhões de anos, acessado por 272 degraus coloridos guardados pela estátua dourada de Murugan de 42m (a maior do mundo). Ao anoitecer, Jalan Alor vira festival de street food chinês-malaio com char kway teow, satay, roti canai por preços de camelô." },
      { title: "George Town, Penang — a cidade UNESCO da comida", story: "Capital da ilha de Penang, cidade colonial britânica-chinesa-indiana-malaia declarada UNESCO em 2008. Ruas heritage com mansões peranakan coloridas, clan jetties (casas palafíticas de clãs chineses de 150 anos), street art de Ernest Zacharevic espalhada pelas paredes, templos de Kuan Yin ao lado de mesquitas Kapitan Keling. Mas Penang é sobretudo comida: capital não-oficial do street food do Sudeste Asiático — assam laksa, char kway teow em fogo de carvão, nasi kandar, cendol, roti tissue de 1m de altura. Uma refeição a cada 3 horas, US$ 3 cada, e Bib Gourmand Michelin em barracas de camelô." },
      { title: "Melaka — a Amsterdam tropical", story: "1h ao sul de KL, Melaka foi porto estratégico das rotas das especiarias — colonizada por portugueses (1511), holandeses (1641) e britânicos (1824), com heranças visíveis em cada rua. Praça holandesa vermelha com relógio Stadthuys, ruínas da igreja portuguesa de São Paulo no morro, Jonker Street chinesa com casas peranakan e night market aos fins de semana com durian pancakes e satay celup (satay mergulhado em molho de amendoim fumegante em mesa comunal). Cristang Village ainda tem descendentes de portugueses falando kristang, dialeto português-malaio do século XVI." },
      { title: "Bornéu (Sabah) — orangotangos, Kinabalu e Sipadan", story: "Do outro lado do Mar da China Meridional, o estado de Sabah cobre o norte do Bornéu Malaio — outra Malásia, tribal e selvagem. Sepilok Orangutan Rehabilitation Centre resgata órfãos e reabilita para floresta (visitas na alimentação 10h e 15h). Rio Kinabatangan em safári de barco entre floresta primária com nasalis-macacos, elefantes-pigmeu de Bornéu, hornbills e crocodilos. Mount Kinabalu (4.095m, o pico mais alto do Sudeste Asiático) escalável em 2 dias sem alpinismo. E, para mergulhadores, Sipadan Island é considerado por Cousteau um dos 5 melhores mergulhos do planeta — parede vertical descendo 600m com barracudas, tubarões e tartarugas em cada respiração." },
      { title: "Langkawi — arquipélago de 99 ilhas na Andaman", story: "Isento de impostos, 99 ilhas cobertas de floresta tropical no Mar de Andaman, entre a costa da Malásia e a Tailândia. SkyBridge curvo de 125m suspenso a 700m de altitude com vista para Tailândia. Cave of Legends em barco entre penhascos calcários com águias-do-mar sendo alimentadas do céu. Datai Bay considerada uma das 10 melhores praias do mundo pela National Geographic. Resorts como The Datai e The Ritz-Carlton entre floresta primária de 10 milhões de anos, com macacos entrando no café da manhã." },
    ],
    beyondUsual: [
      { title: "Cooking class peranakan em casa histórica de George Town", story: "Aula privada com chef nyonya em mansão peranakan restaurada de Penang — culinária híbrida chinesa-malaia com técnicas de 400 anos. Prepara-se assam prawns, chicken kapitan, kuih lapis colorido em 9 camadas. Almoço servido em porcelana Straits Chinese autêntica." },
      { title: "Longhouse stay com povo Iban em Sarawak (Bornéu Malaio)", story: "Pernoite em longhouse tradicional Iban (comunidade de 30 famílias sob um único teto de 200m) no rio Batang Ai, Sarawak. Cerimônia de recepção com tuak (vinho de arroz), dança ngajat, tatuagens tradicionais bornéias, refeição de bambu, contação de mitos xamânicos. Uma das últimas experiências etnográficas autênticas da Ásia." },
      { title: "Mergulho em Sipadan com licença antecipada", story: "Sipadan aceita apenas 120 mergulhadores por dia — permissão obtida com 6+ meses de antecedência. Certificação PADI Advanced obrigatória. Barracuda point (mil barracudas em vórtice), Turtle Cavern (esqueletos de tartarugas presas há séculos), Hanging Gardens de corais moles roxos e amarelos." },
      { title: "Retiro em Taman Negara — floresta primária de 130 milhões de anos", story: "A floresta tropical mais antiga do mundo, mais velha que Amazônia e Congo. Canopy Walkway de 530m suspenso a 45m entre árvores milenares (a mais longa da Ásia). Trilhas com guia orang asli (indígenas semang) para caça de mel selvagem, plantas medicinais. Pernoite em jungle lodge sobre o rio Tembeling." },
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Não. Turismo de até 90 dias sem visto. Passaporte válido por 6 meses." },
      { q: "Quantos dias ficar?", a: "10 a 14 dias para o essencial: KL (2), Melaka (1), Penang (3), Langkawi (3), Bornéu-Sabah (5) — ou substituir Langkawi por Cameron Highlands (plantações de chá). Roteiros de 7 dias cobrem só KL + Penang + Melaka." },
      { q: "É seguro?", a: "Sim. Muito seguro em KL, Penang, Melaka, Langkawi e Sabah. Alguns cuidados básicos com pertences em áreas movimentadas de KL. Evita-se o leste de Sabah (Sandakan/Semporna) desacompanhado apenas por proximidade histórica com Filipinas — com guia é 100% seguro." },
      { q: "Combina com Singapura ou Tailândia?", a: "Perfeitamente. Trem KL–Singapura em 6h ou voo em 55 min. Trem Bangkok–KL clássico via Butterworth (Penang). Muitos clientes fazem 21 dias Tailândia + Malásia + Singapura." },
      { q: "É bom para famílias?", a: "Excelente. Legoland Malaysia em Johor, Sunway Lagoon em KL, praias de Langkawi rasas e seguras, orangotangos em Sepilok que crianças amam, comida acessível para paladares infantis (arroz, macarrão, satay)." },
      { q: "É muçulmana? Como funciona bebida e vestuário?", a: "Malásia tem maioria muçulmana malaia mas é pluralista — hindus, budistas, cristãos em harmonia. Bebida alcoólica disponível em restaurantes, bares e hotéis (não em barracas malaias). Vestuário casual permitido em todo lugar; ombros cobertos apenas em mesquitas (véu emprestado). Ramadã altera horários de restaurantes malaios mas chineses/indianos operam normal." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    ...
    continent: "Ásia",
    country: "Taiwan",
    region: "Taipei, Taroko, Sun Moon Lake & Jiufen",
    slug: "asia/taiwan/taipei-taroko-jiufen",
    name: "Taiwan (Ilha Formosa)",
    bestTime: "Out–Dez (frio seco, ideal). Mar–Mai (primavera, flores de cerejeira). Evite Jun–Set (tufões, calor úmido). Jan–Fev com Lantern Festival e Pingxi Sky Lanterns imperdíveis.",
    tags: ["cultura", "gastronomia", "montanha", "cidade", "familia", "fotografia"],
    imageAiPrompt: "Ultra realistic editorial photo of Taiwan Jiufen old street lantern-lit teahouses at twilight in mountain mist overlooking Pacific coastline, red lanterns glowing, cinematic, no people, magazine travel cover.",
    imageOverrideUrl: taiwanImg,
    intro: "Ilha Formosa — 'ilha bela' como batizaram os portugueses em 1544. Taiwan comprime, em 36.000 km², a modernidade densa de Taipei (com o Taipei 101 e mercados noturnos Michelin), montanhas de 3.000m atravessadas por trem japonês centenário, gargantas de mármore em Taroko, vilas mineiras que inspiraram A Viagem de Chihiro (Studio Ghibli), a cultura do chá oolong mais refinada da Ásia e uma cozinha considerada por Anthony Bourdain a mais subestimada do planeta. Perfeita como destino independente (8–12 dias) ou stopover Japão/Hong Kong.",
    highlights: [
      { title: "Taipei — Taipei 101, mercados noturnos e templos", story: "Taipei 101 (508m) foi o edifício mais alto do mundo entre 2004–2010, com o maior amortecedor de vento visível do mundo — bola de aço de 660 toneladas suspensa entre andares 87 e 92 estabilizando a torre em tufões. Observatório do 89º andar. Ao pôr do sol, Elephant Mountain (20 min de subida) oferece a foto icônica da torre entre os prédios. À noite, Shilin, Raohe ou Ningxia Night Markets — templo taiwanês do street food com stinky tofu, oyster omelet, bubble tea (inventado aqui em 1988), pepper buns saindo do forno de tandoor. Ao amanhecer, templo Longshan (1738) com incenso, oráculos i-ching e devotos rezando." },
      { title: "Taroko Gorge — a garganta de mármore", story: "Na costa leste, o Parque Nacional Taroko é uma garganta de 19 km esculpida pelo rio Liwu em rocha de mármore branco e cinza — paredões de 1.000m onde o mármore aflora em veias visíveis. Trilha Shakadang segue rio de águas turquesa por 4 km entre paredes escavadas, Swallow Grotto passa sob túneis com andorinhas voando, Tunnel of Nine Turns tem vistas de vertigem para o rio. Templo Xiangde encavado em precipício. Um dos parques mais espetaculares e menos falados da Ásia." },
      { title: "Jiufen — a vila que inspirou 'A Viagem de Chihiro'", story: "Antiga vila mineira de ouro na costa nordeste, abandonada em 1971 e redescoberta na década de 1990 quando o filme A Cidade dos Tristes de Hou Hsiao-hsien e depois A Viagem de Chihiro (Miyazaki jurou não ter se inspirado mas admitiu semelhança) a tornaram fenômeno. Ruas de escada estreitas iluminadas por centenas de lanternas vermelhas, casas de chá com terraço para o Pacífico, taro balls quentes, glutinous rice cakes recém-fritos. Ao anoitecer, com neblina subindo do mar, é literalmente o cenário do banho de Chihiro." },
      { title: "Sun Moon Lake e Alishan — o coração da montanha", story: "Sun Moon Lake, o maior lago de Taiwan (7,9 km²) a 748m de altitude nas montanhas centrais, é sagrado para o povo indígena Thao. Templo Wenwu na margem, Ci'en Pagoda de 46m no topo de morro, ciclovia perimetral de 30 km eleita uma das mais bonitas do mundo pela CNN. A 100 km de trem centenário japonês (Alishan Forest Railway, 1912) sobe-se de 30m a 2.216m de altitude em floresta de ciprestes milenares — mar de nuvens ao amanhecer, o cipreste Sacred Tree de 3.000 anos e o famoso amanhecer sobre Yushan (o pico mais alto do Nordeste Asiático, 3.952m)." },
      { title: "Cultura do chá oolong — a mais refinada da Ásia", story: "Taiwan é considerada por especialistas a produtora do melhor oolong do mundo — clima subtropical de montanha, terroir vulcânico, tradição de 200 anos. Nas plantações de Lugu (Nantou) e Alishan, participa-se de colheita, torra e cerimônia gongfu com mestre — degustação de high mountain oolong, dong ding, oriental beauty, alishan cha. Uma folha rende 5–7 infusões. Complementa-se em Maokong, subúrbio de Taipei acessível por teleférico, com salões de chá com vista para a cidade." },
    ],
    beyondUsual: [
      { title: "Pingxi Sky Lantern Festival — soltar lanterna nos trilhos do trem", story: "Na vila de Pingxi (1h de Taipei), tradição de 200 anos: escreve-se desejos em lanterna gigante de papel colorido, acende-se dentro dos trilhos abandonados de trem, e solta-se ao céu. Se coincidir com o Lantern Festival (15º dia do Ano Novo Chinês, Fev–Mar), milhares de lanternas sobem simultaneamente ao anoitecer — uma das cenas mais fotografadas do planeta." },
      { title: "Hot springs em Beitou ou Jiaoxi", story: "Taiwan tem mais de 100 fontes termais vulcânicas. Beitou (30 min de Taipei) tem águas sulfurosas verdes-esverdeadas, herdadas dos japoneses, com ryokan-style onsens tradicionais. Jiaoxi (nordeste) tem águas transparentes sem odor, ideais para banho em suíte privativa com vista para arrozais." },
      { title: "Rota de bicicleta pela costa leste (Hualien–Taitung)", story: "Considerada uma das rotas cicloturísticas mais bonitas do mundo — 180 km entre montanhas de Taroko e o Oceano Pacífico, passando por vilas indígenas Amis, plantações de arroz em socalcos, penhascos de Qingshui (uma das 10 estradas costeiras mais bonitas do mundo). Fazível em 4–5 dias com suporte de van." },
      { title: "Aula de xiaolongbao no Din Tai Fung original", story: "Aula privada nos bastidores do Din Tai Fung (Xinyi flagship, o restaurante que colocou o dumpling taiwanês no mapa Michelin) — aprende-se as 18 dobras exatas do xiaolongbao (o dumpling com sopa dentro) que ganharam Michelin. Almoço com o time de mestres em mesa privativa." },
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Não. Turismo de até 90 dias sem visto. Passaporte válido por 6 meses e passagem de retorno." },
      { q: "Quantos dias ficar?", a: "8 a 12 dias para o essencial: Taipei (3), Jiufen + Pingxi (1), Taroko/Hualien (2), Sun Moon Lake + Alishan (3), Kaohsiung/Tainan (2). Roteiros de 5–6 dias cobrem só Taipei + Jiufen + Sun Moon Lake." },
      { q: "É seguro?", a: "Extremamente seguro. Uma das menores taxas de criminalidade da Ásia. Metrô impecável até meia-noite. Sinalização em inglês em toda parte." },
      { q: "Combina com Japão, Coreia ou Hong Kong?", a: "Perfeitamente. Voos Taipei–Tokyo em 3h30, Taipei–Seul em 2h30, Taipei–Hong Kong em 1h30. Muitos clientes fazem 15 dias Japão + Taiwan ou 12 dias Taiwan + Hong Kong + Macau." },
      { q: "É bom para famílias?", a: "Excelente. Night markets encantam crianças, transporte impecável, hotéis com quartos familiares grandes, comida acessível (macarrão, dumplings, bubble tea), Taipei tem zoo, Miramar Ferris Wheel e Yehliu Geopark com formações rochosas alienígenas." },
      { q: "É muito caro?", a: "Não. Um dos destinos asiáticos com melhor custo-benefício. Hotéis 5 estrelas em Taipei entre R$ 1.200–3.500/noite (metade do Japão). Refeições excelentes por R$ 30–80. Metrô por R$ 5. Táxi barato." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    ...
    continent: "Ásia",
    country: "Vietnã",
    region: "Hanoi, Halong, Hoi An, Saigon & Mekong",
    slug: "asia/vietna/norte-centro-sul",
    name: "Vietnã (Norte, Centro & Sul)",
    bestTime: "Nov–Abr no Norte (Hanoi, Halong — seco). Fev–Ago no Centro (Hoi An, Hue — sem chuva). Dez–Abr no Sul (Saigon, Mekong). Evite Jul–Out no Centro (tufões).",
    tags: ["cultura", "gastronomia", "navegacao", "roadtrip", "familia", "fotografia"],
    imageAiPrompt: "Ultra realistic editorial photo of Vietnam Ha Long Bay at sunrise, red-sail junk boat between limestone karst islands in mist, golden light, no people, magazine travel cover.",
    imageOverrideUrl: vietnaImg,
    intro: "S de 1.650 km de norte a sul, o Vietnã comprime em uma única viagem três países distintos: o Norte de Hanoi milenar, arrozais em socalcos de Sapa e a baía de Halong com 1.600 ilhotas calcárias UNESCO; o Centro com Hue imperial, Hoi An lanterna-a-lanterna e a rota Hai Van dos motociclistas; e o Sul do Saigon frenético e do Delta do Mekong dos mercados flutuantes. Uma das melhores gastronomias do mundo (Anthony Bourdain), custos ainda amigáveis e hospedagem 5 estrelas por metade do preço da Tailândia.",
    highlights: [
      { title: "Halong Bay em junco tradicional de 2 noites", story: "1.600 ilhotas calcárias emergindo do Golfo de Tonkin — patrimônio UNESCO desde 1994 e uma das 7 novas maravilhas naturais do mundo. A bordo de um junco de vela vermelha (Bhaya Legend, Paradise Elegance, Heritage Bình Chuẩn), navega-se por 2 noites entre grutas iluminadas, praias secretas, vilas flutuantes de pescadores em Cua Van. Ao amanhecer, tai chi no convés com a bruma se levantando entre os cumes. Ao pôr do sol, banquete de frutos do mar frescos com o barco ancorado em enseada privativa. Um dos passeios mais cinematográficos da Ásia." },
      { title: "Hoi An — a cidade das lanternas", story: "Ex-porto comercial entre séculos XV e XIX, Hoi An é patrimônio UNESCO com centro histórico intacto — casas de comerciantes chineses e japoneses, ponte coberta japonesa de 1593, templos cantoneses. Ao anoitecer, mil lanternas de seda coloridas se acendem sobre o rio Thu Bồn e turistas soltam pequenas lanternas velas ao rio. Alfaiates confeccionam áo dài ou terno sob medida em 24h por US$ 100. Aula de cozinha na Red Bridge com colheita no mercado de manhã. Praia An Bang a 5 km em ciclovia entre arrozais." },
      { title: "Hanoi — Old Quarter, café e Pho ao amanhecer", story: "O Old Quarter é o labirinto de 36 ruas centenárias, cada uma originalmente dedicada a um ofício (Rua da Prata, do Bambu, do Papel). Amanhece com pho bo (sopa nacional) em Pho Gia Truyen (o melhor de Hanoi, aberto desde 1979); segue com egg coffee (café ovo, invenção hanoiana) no Café Giang; termina com bia hoi (cerveja artesanal a US$ 0,30) sentado em banquinho de plástico na calçada. Templo da Literatura (1070, a primeira universidade do Vietnã), Mausoléu de Ho Chi Minh, água puppetry (marionetes na água, tradição rural de mil anos)." },
      { title: "Sapa e os arrozais em socalcos", story: "Fronteira montanhosa com a China (1.500m altitude), Sapa é o coração das minorias étnicas Hmong Negro, Dao Vermelho, Tay e Giay — povos que cultivam arroz em socalcos que descem os vales há 400 anos, criando a paisagem em terraço mais fotografada do Sudeste Asiático. Trekking de 2–3 dias entre aldeias hospedando em farmhouse Hmong, banho de ervas medicinais Dao Vermelho, comida cozinhada em fogão a lenha. Fansipan (3.147m, o pico mais alto da Indochina) alcançável em teleférico de 15 min." },
      { title: "Delta do Mekong e mercados flutuantes", story: "3h ao sul de Saigon, o delta do maior rio do Sudeste Asiático se ramifica em nove braços (Cửu Long — Nove Dragões). Cai Rang é o maior mercado flutuante do Vietnã — dezenas de barcos vendendo abacaxi, jaca, coco, cada barco com o produto pendurado num mastro para identificação. Homestay em casa de família em Bến Tre entre canais de coco, aula de fazer papel de arroz artesanal, jantar com elephant ear fish frito integral apoiado sobre coluna vertebral." },
      { title: "Hue e a rota imperial", story: "Última capital imperial do Vietnã (1802–1945), Hue tem a Cidadela Imperial modelada em Beijing, tumbas dos imperadores Nguyen espalhadas pelo Rio Perfumado (Tu Duc é a mais bonita), e cozinha considerada a mais refinada do país (bún bò Huế picante, cơm hến de mexilhão). Trecho de trem Hue–Da Nang atravessa o passo Hai Van — 21 km de estrada costeira em curvas cinematográficas que Jeremy Clarkson do Top Gear declarou 'a melhor road do mundo'." },
    ],
    beyondUsual: [
      { title: "Cruzeiro privado de 3 noites em Lan Ha Bay (a Halong sem multidão)", story: "Ao sul de Halong, Lan Ha Bay tem 400 ilhotas e cardápio idêntico mas 90% menos barcos. Junco privativo com 2 cabines, kayak entre grutas, natação em enseadas transparentes, jantar de lulas grelhadas pescadas na hora." },
      { title: "Motorcycle tour pela Hai Van Pass com Easy Riders", story: "Do Hoi An a Hue (150 km) na garupa de moto Minsk soviética conduzida por Easy Rider veterano — 6h atravessando a Hai Van Pass, praia Lang Co, lagoa de An Bang, com paradas para café vietnamita e pho em cidades pesqueiras. A viagem que virou icônica no Top Gear." },
      { title: "Aula de cozinha com chef Michelin em Hanoi", story: "Aula privada com chef vietnamita estrela Michelin em cozinha profissional — foco em pho bo autêntico (24h de caldo), bun cha (o prato que Obama comeu com Bourdain), banh xeo, gỏi cuốn. Mercado com chef, degustação de peixes secos e nước mắm envelhecido em barris de 3 anos." },
      { title: "Trekking hospedado em farmhouse Hmong em Ha Giang", story: "500 km ao norte de Hanoi, Ha Giang é a fronteira selvagem com a China — desconhecida pela maioria dos turistas. Loop de 3 dias em minibus/moto pela mais bela estrada do Vietnã, hospedagem em farmhouses Hmong Negros, mercados de domingo com mulheres em trajes bordados manualmente, banquete de cabra montada." },
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Sim, e-visa online por US$ 25 (obtido em 3–5 dias antes da viagem). Válido por até 90 dias." },
      { q: "Quantos dias ficar?", a: "12 a 15 dias ideais para norte-centro-sul: Hanoi (2), Halong (2), Sapa opcional (2), Hoi An + Hue (3), Saigon (2), Mekong (2). Roteiros de 8 dias cobrem só norte ou sul." },
      { q: "É seguro?", a: "Muito seguro. Uma das menores taxas de criminalidade do Sudeste Asiático. Cuidados básicos com carteiras em áreas turísticas de Saigon e Hanoi. Trânsito de motos caótico mas ordenado." },
      { q: "Combina com Camboja, Laos ou Tailândia?", a: "Perfeitamente. Voos Saigon–Siem Reap em 1h, Hanoi–Luang Prabang em 1h30, Saigon–Bangkok em 1h30. Roteiros clássicos: 21 dias Vietnã + Camboja + Laos." },
      { q: "É bom para famílias?", a: "Excelente. Halong Bay encanta crianças, Hoi An tem oficinas de lanternas e culinária infantis, Mekong com barcos e frutas. Comida acessível (macarrão, arroz, spring rolls)." },
      { q: "É muito caro?", a: "Não. Melhor custo-benefício da Ásia. Hotéis 5 estrelas Anantara/InterContinental/Metropole entre R$ 800–3.500/noite. Refeições excelentes por R$ 20–80. Táxi Grab barato." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    ...
    continent: "Ásia",
    country: "Camboja",
    region: "Angkor, Phnom Penh & Koh Rong",
    slug: "asia/camboja/angkor-mekong",
    name: "Camboja (Angkor & Além)",
    bestTime: "Nov–Fev (seca, 25–30°C, ideal). Mar–Mai (calor extremo até 40°C). Jun–Out (monção mas paisagem mais verde e templos vazios).",
    tags: ["cultura", "fotografia", "expedicao", "conservacao", "gastronomia"],
    imageAiPrompt: "Ultra realistic editorial photo of Angkor Wat Cambodia at sunrise, temple silhouette reflected in lotus pond, orange sky, jungle behind, cinematic, no people, magazine travel cover.",
    imageOverrideUrl: cambojaImg,
    intro: "Angkor Wat, o maior monumento religioso do mundo, é apenas a porta de entrada. O Camboja guarda 4.000 templos khmer espalhados em 400 km² da floresta de Angkor, o rio Tonlé Sap que muda de direção duas vezes por ano, memórias comoventes do genocídio Khmer Vermelho em Phnom Penh e ilhas tropicais quase intactas no Golfo da Tailândia. Perfeito em 7–10 dias, ideal combinado com Vietnã ou Tailândia.",
    highlights: [
      { title: "Angkor Wat ao amanhecer", story: "Chega-se às 4h30 no escuro, atravessa-se a ponte sobre o fosso de 190m de largura, encontra-se posição em frente ao reflexo em pond de lótus. Às 5h30, o sol começa a subir por trás das 5 torres do Angkor Wat (século XII, construído em 30 anos com 5 milhões de toneladas de arenito trazido a 40 km de distância) — silhueta cor-de-laranja que vira o pôster clássico da Ásia. Um dos amanheceres mais fotografados do planeta. À tarde, sobe-se os 3 níveis do templo, contempla-se os 800m de baixos-relevos narrando o Ramayana." },
      { title: "Ta Prohm — o templo estrangulado pelas raízes", story: "O 'templo de Tomb Raider' foi deixado propositalmente pela arqueologia francesa nas condições em que foi encontrado na selva no século XIX — árvores gigantes de spung (Tetrameles nudiflora) crescidas em cima e através dos muros, raízes de 20m de diâmetro estrangulando corredores, mistura assombrosa de arquitetura e natureza. Início da manhã ou fim da tarde para evitar multidão." },
      { title: "Angkor Thom, Bayon e os 216 rostos de pedra", story: "3 km ao norte de Angkor Wat, a antiga capital Angkor Thom (século XIII, 1 milhão de habitantes na época — Paris tinha 200 mil) tem o Bayon no centro — 54 torres, cada uma com 4 rostos gigantes de pedra (216 no total) sorrindo em todas as direções, provavelmente representando o rei Jayavarman VII como bodhisattva de compaixão. Elephant Terrace de 350m usada para receber visitantes reais. Baphuon, pirâmide de 3 níveis restaurada por 50 anos em quebra-cabeça de 300 mil pedras." },
      { title: "Beng Mealea, Banteay Srei e templos remotos", story: "60 km a nordeste, Beng Mealea é o 'Angkor selvagem' — templo do mesmo tamanho de Angkor Wat mas ainda soterrado pela floresta, com passarelas de madeira entre blocos gigantes cobertos de musgo. Banteay Srei ('cidadela das mulheres') é o mais delicado dos templos khmer — pequeno, esculpido em arenito rosa com detalhes finíssimos que só podiam ter sido feitos por mãos femininas, dizem os locais. Preah Vihear no topo de 525m com vista para a Tailândia (patrimônio UNESCO)." },
      { title: "Phnom Penh e a memória do Khmer Vermelho", story: "A capital tem o Palácio Real dourado, o Templo de Prata com 5.000 azulejos de prata, o Mercado Central Art Déco. Mas o coração da visita é o Museu do Genocídio Tuol Sleng (antiga escola convertida em prisão S-21 pelos Khmer Vermelhos, onde 20 mil foram torturados) e o Killing Field de Choeung Ek — memórias essenciais para entender o Camboja moderno. Reservar dia inteiro, guia narrando com sensibilidade. Termina-se no rooftop bar do FCC (Foreign Correspondents Club) ao pôr do sol sobre o Mekong e o Tonlé Sap." },
      { title: "Vilas flutuantes do Tonlé Sap", story: "O maior lago de água doce do Sudeste Asiático — no verão, 2.500 km²; na monção, 16.000 km². Chong Kneas, Kompong Phluk e Kampong Khleang são vilas inteiras sobre palafitas de 8m ou flutuantes com escolas, igrejas e casas navegando. Passeio de barco no fim da tarde entre florestas alagadas, pescadores lançando redes em silêncio absoluto ao pôr do sol." },
    ],
    beyondUsual: [
      { title: "Balão de ar quente sobre Angkor ao amanhecer", story: "Voo de balão sobre a floresta e templos de Angkor às 5h30 — vista aérea de Angkor Wat, Angkor Thom, Bayon e da malha completa de templos que só faz sentido do céu. Champanhe pousado na floresta." },
      { title: "Templo remoto de Koh Ker em 4x4", story: "120 km ao norte, capital khmer entre 928–944, quase desconhecida — pirâmide de 7 níveis com 40m de altura, único templo pré-Angkor no formato piramidal maia. Sem multidão, subida controlada, vista até a Tailândia." },
      { title: "Ilhas de Koh Rong e Koh Rong Samloem", story: "3–4h ao sul de Phnom Penh, ilhas ainda quase intactas no Golfo da Tailândia — areia branca, água transparente com bioluminescência à noite, resorts eco de 12 quartos, pescadores levando barco privativo por US$ 30/dia. A 'nova Tailândia' que ainda não estragou." },
      { title: "Aula com chef Khmer Rouge sobrevivente em Battambang", story: "Battambang, terceira cidade, preserva arquitetura colonial francesa e cena artística. Aula de cozinha khmer com fish amok, lok lak, num pang com chef que sobreviveu ao Khmer Rouge — comida e história em uma única aula transformadora. Passeio no Bamboo Train (norry) improvisado com plataforma de bambu sobre rodas ferroviárias." },
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Sim, e-visa online por US$ 36 (3 dias úteis) ou visto na chegada por US$ 30 em Siem Reap ou Phnom Penh." },
      { q: "Quantos dias ficar?", a: "7 a 10 dias: Siem Reap + Angkor (4), Phnom Penh (2), Battambang (2), Koh Rong opcional (3). Roteiros de 4 dias cobrem só Angkor essencial." },
      { q: "É seguro?", a: "Sim, muito seguro para turistas. Cuidados básicos com carteira em Phnom Penh à noite. Minas terrestres residuais apenas em áreas rurais fora de rotas turísticas." },
      { q: "Combina com Vietnã, Laos ou Tailândia?", a: "Perfeitamente. Voos Siem Reap–Bangkok/Ho Chi Minh/Vientiane em 1h. Cruzeiro fluvial pelo Mekong entre Phnom Penh e Saigon (7 dias) é icônico. Roteiro clássico: 21 dias Tailândia + Camboja + Vietnã." },
      { q: "É bom para crianças?", a: "Sim, com adaptações. Templos exigem 3–4h/dia de caminhada e sol. Idade mínima recomendada 8 anos. Ilhas de Koh Rong ideais para descanso familiar." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    ...
    continent: "Ásia",
    country: "Laos",
    region: "Luang Prabang, Vientiane, Vang Vieng & 4.000 Ilhas",
    slug: "asia/laos/luang-prabang-mekong",
    name: "Laos (Luang Prabang & Mekong)",
    bestTime: "Nov–Fev (seca, 20–28°C, ideal). Mar–Mai (calor + queimadas agrícolas com fumaça). Jun–Out (monção verde, cachoeiras cheias).",
    tags: ["cultura", "bem-estar", "navegacao", "remoto", "conservacao", "gastronomia"],
    imageAiPrompt: "Ultra realistic editorial photo of Luang Prabang Laos at dawn, saffron-robed Buddhist monks in alms procession past golden Wat Xieng Thong, misty Mekong river, French colonial architecture, cinematic, no faces visible, magazine travel cover.",
    imageOverrideUrl: laosImg,
    intro: "O país mais lento e menos visitado do Sudeste Asiático — e talvez o mais tocante. Sem litoral, sem multidão, com apenas 7 milhões de habitantes, o Laos preserva o Sudeste Asiático que Tailândia e Vietnã deixaram no passado. Luang Prabang UNESCO com 33 templos budistas em cidade de 50 mil habitantes, a procissão diária de 400 monges esmolando ao amanhecer, o Mekong descendo lento em cruzeiros de 3 dias, e as 4.000 Ilhas ao sul onde o rio se ramifica no maior arquipélago fluvial da Ásia.",
    highlights: [
      { title: "Tak Bat — procissão dos monges em Luang Prabang ao amanhecer", story: "Todas as manhãs às 5h30, 400 monges budistas em mantos açafrão saem descalços em fila indiana pelas ruas do centro de Luang Prabang recebendo esmolas de arroz das mãos dos moradores ajoelhados na calçada. Tradição diária de mil anos, silêncio absoluto, único sinal são os pés na pedra e o farfalhar dos mantos. Uma das cenas mais espirituais e fotogênicas do budismo Theravada — participar da doação é gesto profundo (com respeito silencioso, sem flash)." },
      { title: "Wat Xieng Thong e os 33 templos de Luang Prabang", story: "Wat Xieng Thong (1560), o templo mais bonito do Laos com telhados descendentes até o chão, mosaicos de vidro colorido narrando a Árvore da Vida, capela funerária dos reis Lao. Wat Mai com fachada dourada de 5m. Wat Visounnarath com estupa da watermelon. Sobe-se os 328 degraus até o Monte Phousi no meio da cidade para o pôr do sol sobre o Mekong e o Nam Khan (dois rios se encontrando ali). Centro histórico é UNESCO desde 1995 — mescla única de temples laos, arquitetura colonial francesa e monges." },
      { title: "Cachoeiras de Kuang Si", story: "30 km ao sul de Luang Prabang, cascatas em 3 níveis descendo 60m em piscinas de água turquesa impossível pela concentração de cálcio. Trilha de 200m sobe até o topo, piscinas para banho em cada patamar. No caminho, Kuang Si Bear Rescue Center abriga ursos-do-sol resgatados do tráfico de bílis. Ir cedo (7h30) para ter as piscinas vazias com luz da manhã." },
      { title: "Cruzeiro pelo Mekong de 3 dias — Luang Prabang a Huay Xai (Chiang Mai fronteira)", story: "A bordo do Mekong Kingdoms Anouvong ou Luang Say Cruise, dois dias descendo o Mekong entre paisagens rurais laos que não mudaram em 200 anos — pescadores em barquinhos de bambu, elefantes se banhando na margem, vilas Hmong e Khmu inacessíveis por estrada. Pernoite em Pakbeng (vila fluvial simples). Termina em Huay Xai na fronteira tailandesa, com opção de continuar até Chiang Mai por terra. O modo mais autêntico de viver o rio-mãe do Sudeste Asiático." },
      { title: "Plain of Jars — o mistério arqueológico", story: "Planalto de Xieng Khouang no nordeste, planícies com 2.100 jarros gigantes de pedra (1m–3m de altura, alguns pesando 30 toneladas) espalhados em 90 sítios — datados de 500 aC a 500 dC, propósito ainda desconhecido (urnas funerárias? containers de bebida ritual? Coleta de água?). Área intensivamente bombardeada na Guerra Secreta Americana (1964–73, o Laos é o país mais bombardeado da história per capita) — trilhas ainda com UXO. Visita guiada com veterano MAG (Mines Advisory Group)." },
      { title: "4.000 Ilhas (Si Phan Don) no sul", story: "Onde o Mekong se ramifica antes de entrar no Camboja, formando 4.000 ilhotas na estação seca — a Ásia lenta absoluta. Don Khong com bicicleta entre arrozais e búfalos, Don Det com hammock à beira-rio, Don Khon com as cataratas Khone Phapheng (a maior cachoeira da Ásia em volume). Golfinhos Irrawaddy criticamente ameaçados avistáveis no crepúsculo (menos de 90 restam no mundo)." },
    ],
    beyondUsual: [
      { title: "Cerimônia Baci — bênção com fios brancos", story: "Ritual animista-budista lao onde xamã ancião amarra fios brancos de algodão nos punhos dos visitantes, convidando os 32 khouan (espíritos-guardiões) ao corpo. Anfitrião jovem serve lao-lao (destilado de arroz). Cerimônia particular em casa de família em Luang Prabang." },
      { title: "Almoço em Elephant Conservation Center (não passeios com montaria)", story: "A 20 km de Luang Prabang, ECC resgata elefantes explorados por indústria madeireira lao. Sem montaria, apenas observação, alimentação, banho no lago com elefantes. Modelo ético premiado internacionalmente." },
      { title: "Aula de cozinha em Tamarind com Joy Ngeuamboupha", story: "Aula com pioneira da cozinha lao autêntica em Luang Prabang — visita ao mercado (búfalo cru para larb, ervas endêmicas), preparo de mok pa (peixe cozido em folha de bananeira), or lam (cozido tradicional), sticky rice (arroz nacional comido com mão)." },
      { title: "Motocicleta pelo loop de Bolaven Plateau", story: "500 km ao sul, planalto vulcânico coberto de plantações de café orgânico (o melhor café do Sudeste Asiático). Loop de 3 dias em moto entre cachoeiras Tad Fane (120m), vilas Katu e Alak, degustações em fazendas de café da família Sinouk. Fora dos circuitos turísticos por completo." },
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Sim, e-visa online por US$ 50 (2 dias úteis) ou visto na chegada por US$ 30–42 (Luang Prabang, Vientiane, Vang Vieng, fronteiras terrestres com Tailândia e Vietnã)." },
      { q: "Quantos dias ficar?", a: "6 a 9 dias: Luang Prabang (3–4), cruzeiro Mekong (2), Vientiane (1), 4.000 Ilhas opcional (3). Roteiros de 4 dias cobrem só Luang Prabang." },
      { q: "É seguro?", a: "Sim, muito seguro. Tráfego lento, criminalidade quase inexistente, hospitalidade genuína. Cuidado apenas com áreas rurais de Xieng Khouang (UXO — sempre em trilhas marcadas)." },
      { q: "Combina com Vietnã, Camboja ou Tailândia?", a: "Perfeitamente. Voos Luang Prabang–Chiang Mai/Bangkok/Hanoi/Siem Reap em 1h–1h30. Rota clássica: 21 dias Tailândia + Laos + Vietnã, ou 14 dias Laos + Camboja." },
      { q: "É bom para famílias?", a: "Sim, com foco em Luang Prabang. Cachoeiras de Kuang Si, elephant conservation, mercado noturno, culinária. Menos apropriado para adolescentes que buscam ação." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    ...
    region: "Yangon, Bagan, Mandalay & Lago Inle",
    slug: "asia/mianmar/bagan-inle",
    name: "Mianmar (Bagan & Inle)",
    bestTime: "Nov–Fev (seca, ideal). Evite Mar–Mai (calor extremo 40°C+). Jun–Out (monção, mas paisagem verde e templos vazios). Verifique situação política atual antes de reservar.",
    tags: ["cultura", "expedicao", "fotografia", "remoto", "conservacao"],
    imageAiPrompt: "Ultra realistic editorial photo of Bagan Myanmar at sunrise, hundreds of ancient stupas emerging from mist, hot air balloons floating above, warm golden light, cinematic, no people, magazine travel cover.",
    imageOverrideUrl: mianmarImg,
    intro: "O último grande destino da Ásia ainda quase intacto. Isolado por 50 anos de ditadura militar, Mianmar preserva 4.000 templos budistas em Bagan (mais que Angkor), a Pagoda Shwedagon dourada de 99m em Yangon, o Lago Inle onde pescadores Intha remam com uma perna, e a hospitalidade genuína de um povo que ainda descobre o turismo. Verifique situação política e alertas do MRE antes de reservar — para os viajantes mais experientes.",
    highlights: [
      { title: "Bagan — 4.000 templos ao amanhecer de balão", story: "No centro de Mianmar, a planície de Bagan tem 4.000 templos e stupas construídos entre 1057–1287 no reino de Pagan — a maior concentração de arquitetura budista do planeta (Angkor tem 800). Ao amanhecer, sobe-se em balão da Balloons Over Bagan (empresa britânica pioneira) e vê-se o sol nascer sobre um mar de stupas emergindo da bruma. Ao anoitecer, sobe-se templo Shwesandaw (o único aberto) para o pôr do sol vermelho absoluto. Ananda Temple (o mais bonito, 1105), Dhammayangyi (o maior), Thatbyinnyu (o mais alto, 61m)." },
      { title: "Shwedagon Pagoda em Yangon", story: "O templo budista mais sagrado de Mianmar e um dos mais impressionantes do mundo — stupa dourada de 99m coberta por 60 toneladas de folhas de ouro puro, coroada por 7.000 diamantes (incluindo um de 76 quilates no topo). Diz-se que contém 8 fios de cabelo de Buda. Centenas de templos menores em volta, monges e leigos circumambulando 24h, o dourado brilhando em cada ângulo. Ao anoitecer, quando é iluminada, é uma das visões mais espirituais do budismo mundial." },
      { title: "Lago Inle e pescadores de uma perna", story: "No planalto Shan a 900m, o Lago Inle (22 km) é o coração do povo Intha — famosos pela técnica única no mundo de remar com uma perna enrolada no remo, deixando as mãos livres para lançar rede. Vilas inteiras palafíticas sobre a água (Ywama, Nampan, Indein), floating gardens onde cultivam tomates hidropônicos, oficinas de tecelagem em fibra de lótus (o único lugar do mundo). Mercado rotativo de 5 dias entre vilas com povo Pa'o, Danu, Kayah em trajes tradicionais." },
      { title: "Mandalay e a ponte U Bein", story: "Última capital birmanesa antes da colonização britânica (1857), Mandalay tem o Palácio Real (reconstruído após bombardeios da 2ª Guerra), Mahamuni Pagoda com Buda dourado de 4m coberto por 15 toneladas de folhas de ouro aplicadas por peregrinos há 100 anos. A ponte U Bein em Amarapura (subúrbio) é a mais longa ponte de teca do mundo — 1,2 km de troncos de 200 anos atravessando o Lago Taungthaman, monges em manto vermelho atravessando ao pôr do sol — a foto icônica." },
      { title: "Cruzeiro pelo Rio Irrawaddy — Mandalay a Bagan (3 dias)", story: "O rio-mãe de Mianmar (2.170 km, quase todo navegável), atravessado em barco tradicional Sanctuary Ananda ou Belmond Road to Mandalay em 3 dias entre Mandalay e Bagan. Paradas em Mingun (templo inacabado que seria o maior do mundo — 150m planejados, 50m construídos), Sagaing Hill com 500 pagodas nos morros ('a Meca birmanesa'), Ava com carruagem de cavalo entre ruínas de ex-capital de 400 anos." },
    ],
    beyondUsual: [
      { title: "Homestay em vila Intha no Lago Inle", story: "Pernoite em casa palafítica de família Intha à beira do lago — jantar de tomate frito, peixe do lago em folha de bananeira, chá verde local. Ao amanhecer, acompanha-se o anfitrião pescar com técnica da perna única. Experiência humana rara." },
      { title: "Balão de ar quente sobre Bagan ao amanhecer", story: "Vale cada centavo. 45 min de voo silencioso sobre 4.000 templos com sol nascendo — a foto de capa do Mianmar. Champanhe pousado no meio dos templos." },
      { title: "Retiro de meditação Vipassana em mosteiro em Mandalay", story: "3 a 10 dias de retiro silencioso em mosteiro budista Theravada (Mahasi Sasana Yeiktha), técnica Vipassana original de Buda. Doação sugerida, sem custo obrigatório. Para os mais espirituais." },
      { title: "Mrauk U — o Bagan esquecido no oeste", story: "Estado Rakhine ao oeste, ex-capital do Reino de Arakan (1430–1785), tem 100 templos-fortalezas em pedra preta espalhados em vale rural inacessível por estrada asfaltada (barco Rio Kaladan + terra). Praticamente sem turistas. Verificar segurança regional antes." },
    ],
    stays: [],
    faq: [
      { q: "É seguro viajar para Mianmar hoje?", a: "Situação instável desde o golpe militar de 2021. Áreas de fronteira (Rakhine, Chin, Kayin, Shan norte) NÃO recomendadas. Rotas turísticas centrais (Yangon, Bagan, Mandalay, Lago Inle) mantiveram operação com hotelaria internacional. Consulte alertas do MRE brasileiro atualizados. Reserve apenas com operadora especializada." },
      { q: "Brasileiros precisam de visto?", a: "Sim, e-visa online por US$ 50 (3 dias úteis). Sanções internacionais podem afetar pagamento — leve dólares em espécie novos e limpos, cartão de crédito internacional funciona em hotéis 5 estrelas apenas." },
      { q: "Quantos dias ficar?", a: "7 a 10 dias: Yangon (2), Bagan (3), Mandalay + cruzeiro Irrawaddy (3), Lago Inle (2)." },
      { q: "Combina com Tailândia?", a: "Sim. Voos Bangkok–Yangon em 1h30. Muitos clientes fazem 21 dias Tailândia + Mianmar." },
      { q: "Como pagar?", a: "Dólares americanos em notas grandes (100 e 50), impecáveis, pós-2006 e sem dobras/rasgos são a moeda paralela. Kyat local para gastos pequenos." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    ...
    continent: "Ásia",
    country: "Tailândia",
    region: "Bangkok, Chiang Mai, Norte & Ilhas do Sul",
    slug: "asia/tailandia/bangkok-chiang-mai-ilhas",
    name: "Tailândia (Norte, Cultura & Ilhas)",
    bestTime: "Nov–Fev (seca, ideal para norte e sul). Mar–Mai (calor extremo). Jun–Out (monção — sul de Phuket e Krabi tem chuvas curtas; norte é verde). Songkran (13–15 abr) é o Ano Novo Tailandês com festival de água nacional.",
    tags: ["cultura", "gastronomia", "praia", "familia", "lua-de-mel", "mergulho", "bem-estar"],
    imageAiPrompt: "Ultra realistic editorial photo of Wat Arun Bangkok at blue hour reflected on Chao Phraya river, longtail boat crossing water, tropical cinematic, no people, magazine travel cover.",
    imageOverrideUrl: tailandiaImg,
    intro: "A introdução perfeita ao Sudeste Asiático — e a mais bem-servida turisticamente do continente. Bangkok caótica e sublime, Chiang Mai budista e artesanal, montanhas Karen e Hmong no extremo norte, e mais de 300 ilhas nos Mares de Andaman e do Golfo com águas transparentes e rochas calcárias saindo do mar. Perfeita para 12–15 dias (norte + sul), como stopover de 5 dias em Bangkok, ou como conjugado com Camboja, Laos, Mianmar ou Vietnã.",
    highlights: [
      { title: "Bangkok — Grand Palace, templos e street food Michelin", story: "O Grand Palace (1782) e Wat Phra Kaew (Buda de Esmeralda) formam o coração espiritual do reino — telhados dourados, mosaicos de vidro e cerâmica, guardas de yaksha (demônios) coloridos. Do outro lado do rio Chao Phraya, Wat Arun (Templo do Amanhecer) com prang central de 82m em porcelana chinesa. À noite, jantar de street food com estrela Michelin (Jay Fai, na rua, servindo omelete de caranguejo com touca de ski desde 1975). Rooftop bar no Marriott Vertigo, no 61º andar, para o pôr do sol sobre a metrópole. Manhã em barco longtail pelos khlongs (canais) do antigo Bangkok flutuante." },
      { title: "Chiang Mai — templos, cooking class e artesanato", story: "Capital do antigo Reino Lanna no norte, 700 anos de história em cidade murada de 4 km². Wat Phra Singh, Wat Chedi Luang (ruína de stupa de 82m destruído por terremoto em 1545), Wat Umong entre floresta com túneis de meditação. Ao pôr do sol, sobe-se ao Doi Suthep (1.676m) — templo dourado com vista para toda a cidade, sinos de bronze e monges recitando mantras. Aula de cozinha na Thai Farm Cooking School em fazenda orgânica (mercado + colheita + 5 pratos + jantar por US$ 40). Night Bazaar e Sunday Walking Street com artesanato Karen, Hmong e Akha." },
      { title: "Triângulo Dourado e vilas de montanha do Norte", story: "3h ao norte de Chiang Mai, o Triângulo Dourado é o encontro do Rio Mekong com o Ruak — fronteira entre Tailândia, Laos e Mianmar, historicamente epicentro do ópio (Hall of Opium é excelente museu). Chiang Rai com o famoso White Temple (Wat Rong Khun) de Chalermchai Kositpipat — arquitetura contemporânea branca com espelhos, cenas surrealistas do Freddy Krueger e Super-Homem esculpidas em muros budistas. Vilas Karen com mulheres de pescoço longo (com discernimento ético — visitar apenas cooperativas que retornam renda direta), Akha, Lisu em trekking de 2 dias." },
      { title: "Phuket, Phi Phi e as ilhas de Andaman", story: "Phuket é a maior e mais desenvolvida ilha da Tailândia — resorts de todos os padrões, Old Town portuguesa-chinesa, Big Buddha branco. Mas o show é a Ao Phang Nga em barco privativo — Ilha James Bond (do filme O Homem com a Pistola de Ouro, monólito calcário vertical saindo do mar), Ilha de Hong com laguna interna acessível só por caiaque em cavernas de teto baixo na maré baixa. As Phi Phi Islands (do filme A Praia com Leonardo DiCaprio) têm Maya Bay em ilhas mais desertas na alta temporada. Similan Islands ao norte é considerado top 10 mergulhos do mundo." },
      { title: "Koh Samui, Koh Phangan e Golfo da Tailândia", story: "Do outro lado do país, Golfo mais calmo com monção invertida (jul–set é bom). Koh Samui com resorts luxuosos (Six Senses Samui, Anantara), Koh Phangan com Full Moon Party mensal e o oposto — retiros silenciosos de yoga em Haad Salad. Koh Tao é o paraíso do certificado PADI mais barato do planeta (US$ 250 pelo Open Water)." },
      { title: "Ayutthaya — a capital destruída", story: "1h30 ao norte de Bangkok, ex-capital do Sião entre 1350–1767, destruída pelos birmaneses. Ruínas UNESCO com prangs de tijolo, Buda em raízes de figueira (a cabeça esculpida engolida pela árvore), palácio real em ruínas. Ideal em day trip ou 1 noite em riverside boutique hotel. Cruzeiro do Chao Phraya (Anantara Cruise) de Bangkok a Ayutthaya em 3 dias é experiência premium." },
    ],
    beyondUsual: [
      { title: "Elephant Nature Park — santuário ético em Chiang Mai", story: "Fundado por Lek Chailert (National Geographic Hero), abriga 90 elefantes resgatados de indústria madeireira, mendicância urbana e circos. Sem montaria, sem show — apenas observação, alimentação com melancia e frutas, banho no rio. Um dos únicos santuários éticos certificados do mundo." },
      { title: "Retiro silencioso Vipassana em Wat Suan Mokkh", story: "10 dias em silêncio absoluto em mosteiro budista em Chaiya (sul da Tailândia), meditação de 4h da manhã até 21h, alimentação vegetariana simples. Grátis (donation-based). Para os mais experientes espiritualmente." },
      { title: "Cooking class Michelin com Chef Jay Fai (Bangkok)", story: "Reserva com meses de antecedência. A senhora de touca de ski cozinhando omelete de caranguejo e drunken noodles em wok gigante na rua tem estrela Michelin desde 2018. Almoço e conversa com a chef mais icônica de Bangkok." },
      { title: "Cruzeiro privado 4 dias em veleiro pelo mar de Andaman", story: "Iate privativo com 3 cabines saindo de Phuket, navegando entre Phi Phi, James Bond, Hong Island, Koh Yao Noi (a ilha rural que Time nomeou top 10 places to see) — pernoites em enseadas isoladas, chef a bordo, mergulho livre em cada parada." },
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Não. Turismo de até 60 dias sem visto (extensão de 30 dias possível na imigração)." },
      { q: "Quantos dias ficar?", a: "10 a 15 dias ideais: Bangkok (3), Chiang Mai + Norte (4), Ilhas Sul (5). Roteiros de 7 dias cobrem Bangkok + Phuket (mais fácil) ou Bangkok + Chiang Mai (mais cultural)." },
      { q: "É seguro?", a: "Muito seguro. Uma das culturas turísticas mais estabelecidas do mundo, hospitalidade lendária. Cuidados básicos: scam de tuk-tuk oferecendo tour de 20 baht (evitar), sempre negociar táxi antes ou usar Grab, cuidado com jet-ski em Phuket (scam clássico)." },
      { q: "Combina com Camboja, Laos, Vietnã ou Mianmar?", a: "Perfeitamente — Bangkok é o hub do Sudeste Asiático. Voos para todas as capitais em 1–2h. Rotas clássicas: 14 dias Tailândia + Camboja, 21 dias Tailândia + Vietnã, 15 dias Tailândia + Laos." },
      { q: "É bom para famílias?", a: "Excelente. Elephant Nature Park, praias rasas em Krabi, cooking classes divertidas, comida acessível para paladares infantis (arroz, pad thai sem apimentar, frutas tropicais)." },
      { q: "É bom para lua-de-mel?", a: "Sim. Anantara, Six Senses, Belmond têm as melhores hospedagens para casais em Koh Samui, Krabi, Phuket. Bangalôs sobre água, spa a dois, jantar privativo na praia — a metade do preço das Maldivas com experiência similar." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    id: "asia-japao-kansai",
    continent: "Ásia",
    country: "Japão",
    region: "Kyoto, Osaka, Nara & Kansai",
    slug: "asia/japao/kyoto-osaka-nara",
    name: "Japão — Kansai (Kyoto, Osaka & Nara)",
    bestTime: "Fim de Mar–início de Abr (sakura, cerejeiras — reserva com 8+ meses). Meados Nov (koyo, folhagem vermelha, tão espetacular quanto sakura). Evite Jul–Ago (calor úmido 35°C+).",
    tags: ["cultura", "gastronomia", "fotografia", "bem-estar", "lua-de-mel", "familia"],
    imageAiPrompt: "Ultra realistic editorial photo of Kyoto Fushimi Inari thousands of vermillion torii gates tunnel in autumn foliage, soft filtered light, cinematic, no people, magazine travel cover.",
    imageOverrideUrl: japaoKansaiImg,
    intro: "Se Tokyo é o Japão futuro, o Kansai é o Japão profundo. Kyoto guarda 1.600 templos budistas, 400 xintoístas, 17 patrimônios UNESCO e os últimos gueixas ainda ativas em Gion. Osaka é a capital gastronômica do país (a cidade da 'kuidaore', 'comer até cair'). Nara guarda o Grande Buda de bronze de 15m no maior edifício de madeira do mundo, cercado por 1.200 cervos livres que reverenciam quem os alimenta. Um roteiro de 8–10 dias que muda a percepção de estética, silêncio e tempo.",
    highlights: [
      { title: "Fushimi Inari — 10.000 torii vermelhos", story: "Templo xintoísta no sudeste de Kyoto dedicado a Inari (deusa do arroz e prosperidade), com 10.000 torii vermelhos formando túnel contínuo subindo o monte Inariyama por 4 km — cada torii doado por família ou empresa em agradecimento. Ir às 6h da manhã (portões nunca fecham, gratuito) para ter os corredores vazios. Kitsune (raposas mensageiras de pedra) em cada estação." },
      { title: "Kinkaku-ji, Ryoan-ji e os templos zen", story: "Kinkaku-ji (Pavilhão Dourado) é o templo mais fotografado do Japão — dois andares superiores cobertos em folha de ouro puro se refletindo em lago de espelho, o pavilhão original é de 1397 (reconstruído em 1955 após incêndio). Ryoan-ji tem o mais famoso jardim zen do mundo — 15 pedras em areia branca, dispostas de forma que apenas 14 são visíveis de qualquer ângulo (a 15ª só é vista pelo iluminado). Ginkaku-ji (Pavilhão de Prata) e Philosopher's Path com 2 km de cerejeiras à beira de canal." },
      { title: "Gion e as gueixas de Kyoto", story: "Bairro tradicional preservado com casas de madeira ochaya (casas de chá), lanternas de papel washi, ruas de pedra Hanamikoji. Ao anoitecer, entre 17h30 e 18h30, geiko (gueixas de Kyoto) e maiko (aprendizes) atravessam correndo entre casas de chá para compromissos privados com clientes seculares — flash proibido, respeito absoluto. Jantar kaiseki com maiko privada em ochaya requer introdução (arranjamos) — noite inaugural de arte, dança, shamisen." },
      { title: "Osaka — Dotonbori, kuidaore e Michelin", story: "Osaka é a capital gastronômica do Japão — 'kuidaore' significa 'arruinar-se comendo'. Dotonbori é a rua de neon com o Glico Man icônico, takoyaki (bolinhos de polvo) grelhados na hora, okonomiyaki (panqueca salgada mista) preparada na chapa da mesa, kushikatsu (espetinhos empanados fritos com regra de não molhar duas vezes no shoyu compartilhado). Osaka tem mais estrelas Michelin per capita que qualquer cidade do Japão. Castelo de Osaka (1583, reconstruído) com 8 andares e vista panorâmica." },
      { title: "Nara e o Grande Buda", story: "40 min de Kyoto por trem local, ex-capital imperial (710–784). Todai-ji abriga o Grande Buda Daibutsu de bronze de 15m e 500 toneladas, o maior do mundo, dentro do Daibutsuden — o maior edifício de madeira do mundo (57m altura). 1.200 cervos livres considerados mensageiros dos deuses xintoístas circulam pelo parque de 500 ha, aprenderam a fazer reverência para ganhar shika-senbei (biscoitos)." },
      { title: "Arashiyama — bambuzal, macacos e ryokan", story: "Oeste de Kyoto, bambuzal Sagano de 500m com bambus de 20m formando corredor verde-filtrando-luz (mais mágico ao amanhecer). Templo Tenryu-ji zen com jardim UNESCO. Monkey Park Iwatayama no morro (30 min de subida) com 130 macacos-japoneses selvagens e vista para Kyoto. Ryokan tradicionais como Hoshinoya Kyoto (acessível só por barco pelo rio Hozu) para pernoite em tatami com onsen privativo." },
    ],
    beyondUsual: [
      { title: "Aula de cerimônia do chá com mestre em Kyoto", story: "Casa de chá centenária Camellia, aula privada com mestre em quimono — do preparo da matcha em pó batido com chasen (batedor de bambu 100 hastes) até etiqueta de três giros da tigela. Uma das cerimônias mais estéticas e meditativas do Japão." },
      { title: "Dinner com maiko privada em ochaya de Gion", story: "Jantar kaiseki privativo de 10 pratos com maiko autêntica servindo saquê, jogando ozashiki asobi (jogos tradicionais), dançando kyomai (dança de Kyoto) ao som de shamisen. Requer introdução formal e reserva com 3+ meses." },
      { title: "Ryokan Hoshinoya em Arashiyama (acessível só por barco)", story: "Ryokan luxo de 25 pavilhões à beira do rio Hozu, acessível apenas por barco de 15 min. Onsen privativo em cada suíte, kaiseki servido em quarto, aula de origami e caligrafia com mestre. A experiência ryokan definitiva do Japão." },
      { title: "Sushi omakase no balcão do Sushi Yoshitake (Kyoto branch)", story: "Reserva com 3 meses. Sushi omakase de 15 peças no balcão de 8 lugares, cada peça posta na frente pelo próprio chef, tratada como uma performance artística. 3 estrelas Michelin, uma das melhores experiências gastronômicas do mundo." },
    ],
    stays: [],
    faq: [
      { q: "Brasileiros precisam de visto?", a: "Não. Turismo de até 90 dias sem visto. Passaporte válido por 6 meses." },
      { q: "Quantos dias no Kansai?", a: "8 a 10 dias ideais: Kyoto (5–6, incluindo Arashiyama e Fushimi Inari em dias diferentes), Osaka (2), Nara (day trip ou 1 noite), Himeji (day trip para o castelo UNESCO). Combina perfeitamente com Tokyo em roteiro de 15 dias." },
      { q: "É melhor Kansai ou Tokyo?", a: "Ambos, e em ordem: se primeira vez, Tokyo (5) + Kansai (7). Tokyo é o Japão futuro; Kansai é o Japão milenar. Um sem o outro é incompleto." },
      { q: "Sakura ou koyo — qual é melhor?", a: "Ambos são sublimes. Sakura (fim de março–início de abril) tem 10 dias exatos de floração, hotéis lotam 8 meses antes, preços dobram. Koyo (meados de novembro) tem 3 semanas de folhagem vermelha, menor demanda, mesmo espetáculo visual. Para primeira vez: sakura vale o esforço." },
      { q: "É caro?", a: "Sim, o Japão é caro por padrão. Ryokan tradicional 800–3.000 USD/noite. Refeições Michelin 200–500 USD/pessoa. Mas 3 estrelas de sushi por 200 USD, kaiseki de 200 USD e onsen incluído são custo-benefício absurdo para o que se recebe." },
      { q: "Como criar meu roteiro?", a: "Clique em Criar roteiro sob medida." },
    ],
  },
  {
    id: "asia-japao-hokkaido",
    continent: "Ásia",
    country: "Japão",
    region: "Sapporo, Niseko, Furano & Shiretoko",
    slug: "asia/japao/hokkaido",
    name: "Japão — Hokkaido (Neve, Onsen & Selvagem)",
    bestTime: "Dez–Fev (neve profunda de pó, ski Niseko + Festival de Neve Sapporo). Jun–Jul (campos roxos de lavanda em Furano). Ago–Set (verde). Set–Out (folhagem). Evite Abr–Mai (derretimento).",
    tags: ["montanha", "bem-estar", "conservacao", "gastronomia", "fotografia", "expedicao"],
    imageAiPrompt: "Ultra realistic editorial photo of Hokkaido Japan winter landscape with snow-covered Biei blue pond, snow-laden birch trees, frozen surface, turquoise water, cinematic soft light, no people, magazine travel cover.",
    imageOverrideUrl: japaoHokkaidoImg,
    intro: "A ilha mais ao norte do arquipélago japonês, apenas 5% da população em 20% do território — o Japão selvagem. Neve pó considerada a melhor do planeta (Niseko), campos de lavanda roxa que se estendem até o horizonte em Furano, ursos selvagens Ussuri e ecoturismo em Shiretoko UNESCO, onsens em cabana de neve, sushi de mercado matinal em Sapporo e a cultura Ainu (povo indígena japonês). Um roteiro totalmente diferente do Kansai/Tokyo — recomendado para segunda viagem ao Japão.",
    highlights: [
      { title: "Niseko — a melhor neve pó do mundo", story: "Estação de esqui em Hokkaido oeste, considerada por revistas especializadas (Ski Magazine, Powder) como a melhor neve pó do planeta — 15m de precipitação anual de neve seca soprada da Sibéria via Mar do Japão. 61 pistas conectadas em Grand Hirafu, Hanazono, Niseko Village e Annupuri. Free ride em backcountry com guia, night skiing sob nevada até 20h30, onsen ao ar livre com neve caindo, ryokan-hotel Zaborin com 15 pavilhões e cada um com onsen privativo. Cerveja Sapporo e sashimi de kani (caranguejo real) no jantar." },
      { title: "Sapporo Snow Festival (fevereiro)", story: "Um dos maiores festivais de inverno do mundo — 250 esculturas gigantes de neve e gelo no Odori Park (mais de 15m de altura, réplicas de templos, personagens de anime, monumentos mundiais), iluminadas à noite. Barracas de sopa de miso Sapporo, jingisukan (churrasco de cordeiro na chapa em formato de chapéu de Genghis Khan), Kirin ice-cold. 2 milhões de visitantes em 7 dias." },
      { title: "Furano e os campos de lavanda", story: "Junho–julho, o vale de Furano vira mar roxo de lavanda estendendo-se por 25 hectares em Farm Tomita (o maior campo do Japão) — cultivado desde 1958 quando os fazendeiros importaram sementes da Provença francesa. Sorvete de lavanda, sabonete de destilaria própria, colheita permitida. Nearby, Biei tem o Blue Pond turquesa-neon (fenômeno de partículas de alumínio da erupção do Monte Tokachi em 1988) e o Panorama Road entre morros dourados." },
      { title: "Shiretoko UNESCO — a última fronteira", story: "Península no extremo nordeste, patrimônio UNESCO natural desde 2005, considerada 'o fim do mundo' pelo Ainu (Sir-etok). 600 ursos-marrons Ussuri (a maior densidade do mundo, mais do que Alaska por km²), águias-do-mar Steller no inverno, salmões subindo rios cristalinos no outono. Cruzeiro para ver ursos na praia, trilha nos cinco lagos, cachoeira Oshinkoshin. Zero infraestrutura hoteleira internacional — pousadas japonesas simples." },
      { title: "Mercado Nijo em Sapporo e sushi ao amanhecer", story: "Mercado de peixes de Sapporo aberto às 7h com kani (caranguejo real, o maior do mundo, pinças de 1m), uni (ouriço-do-mar do norte, o melhor do Japão), ikura (ovas de salmão vermelhas), toro (barriga de atum). Sushi omakase em barracas do próprio mercado por US$ 30 (o mesmo em Tokyo custa 5x). Café da manhã que muda a definição de sushi." },
      { title: "Cultura Ainu e Lago Akan", story: "Ainu é o povo indígena de Hokkaido — reconhecido oficialmente como povo indígena pelo governo japonês apenas em 2019. Museu Nacional Ainu Upopoy em Shiraoi (2020), aldeias culturais em Lake Akan com performances de dança, mukkuri (harpa de boca), tatuagens tradicionais (proibidas pelos japoneses em 1899). Onsen do Lago Akan em ryokan Tsuruga Wings à beira-lago, marimo (algas verdes esféricas raras patrimônio nacional)." },
    ],
    beyondUsual: [
      { title: "Snowshoeing entre florestas nevadas em Daisetsuzan National Park", story: "Maior parque nacional do Japão (2.300 km²), 'teto do Hokkaido' com picos de 2.290m. Trilha de raquete de neve entre pinheiros e bétulas cobertas por metro de neve, silêncio absoluto quebrado só por veados-sika, encontro com fontes termais naturais fumegantes em meio à neve." },
      { title: "Cruzeiro de icebergs (drift ice) em Abashiri (fev)", story: "Mar de Okhotsk, o mais austral onde o mar congela — icebergs à deriva chegam da Sibéria em fev–mar. Cruzeiro de 1h em quebra-gelo Aurora atravessando os blocos brancos, focas e águias observáveis do convés. Único no Japão." },
      { title: "Ryokan Zaborin em Niseko", story: "Ryokan luxo boutique de 15 pavilhões isolados na floresta, cada um com onsen próprio interno e externo, café da manhã kaiseki servido em quarto. Chef japonês estrelado, biblioteca de saquê raro, aula de arco e flecha kyudo. Um dos ryokans mais premiados da Ásia." },
      { title: "Wildlife photography com fotógrafo local em Shiretoko", story: "Fotografia dedicada de ursos-marrons Ussuri (jul–set — pesca de salmão), águias-do-mar Steller e coruja-de-pesca-de-Blakiston (ave mais rara do Japão), com fotógrafo de wildlife veterano em blinds e safaris de barco." },
    ],
    stays: [],
    faq: [
      { q: "Como chegar em Hokkaido?", a: "Voo direto Tokyo–Sapporo (New Chitose) em 1h30 (JAL, ANA), Osaka–Sapporo em 2h. Alternativa cinematográfica: shinkansen Hayabusa Tokyo–Hakodate em 4h30 atravessando o Túnel Seikan (o mais longo túnel ferroviário submarino do mundo)." },
      { q: "Quantos dias em Hokkaido?", a: "7 a 10 dias ideais: Sapporo (2), Niseko esqui (3, inverno) ou Furano lavanda (2, verão), Otaru + Hakodate (2), Shiretoko/Akan (3, se aventureiro). Combina com Tokyo em roteiro de 14 dias." },
      { q: "Melhor época?", a: "Depende do interesse. Ski/neve: dez–fev (Niseko é internacional em jan–fev). Lavanda: junho–julho (Farm Tomita pico). Folhagem outonal: fim de setembro–meados de outubro (2 semanas antes do resto do Japão). Ursos: julho–setembro." },
      { q: "É bom para famílias?", a: "Sim, mas exige planejamento. Verão é ideal com Furano flor, mercados, ski simulator para crianças, ferrocarriles em cenário. Inverno com ski school infantil em Niseko é premium mas caro." },
  ...
  ...polosExtraDestinations,
  ...caucasoAsiaExtraDestinations,
  ...andesAlpesExtraDestinations,
