...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    highlights: [
      ...
      { title: "Safari no deserto e jantar bedu", style: "Sai-se de 4x4 Land Cruiser às 15h em direção às dunas vermelhas de Al Awir. Dune bashing (uma hora subindo e descendo dunas de 100m em velocidade — mais adrenalina que qualquer parque), sandboard, camelo ao pôr do sol vermelho absoluto, chegada ao camp bedu com jantar de zarb (cordeiro cozido sob a areia), narguilé, henna, dança do ventre e falcoaria. Retorno à meia-noite. Um dos programas obrigatórios do Golfo.", story: "Sai-se de 4x4 Land Cruiser às 15h em direção às dunas vermelhas de Al Awir. Dune bashing (uma hora subindo e descendo dunas de 100m em velocidade — mais adrenalina que qualquer parque), sandboard, camelo ao pôr do sol vermelho absoluto, chegada ao camp bedu com jantar de zarb (cordeiro cozido sob a areia), narguilé, henna, dança do ventre e falcoaria. Retorno à meia-noite." },
