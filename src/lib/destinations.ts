...
export const destinations: Destination[] = [
  ...
  },
  {
    ...
    itineraries: [
      {
        title: "Indonésia completa + Istambul — Bali, Komodo, Ubud, Gilis, Nusa Dua & Turquia",
        duration: "19 dias / 17 noites",
        pricePerPerson: "7.788",
        currency: "USD",
        priceBasis: "Preço por pessoa em quarto triplo",
        taxes: "Encargos, taxas e impostos: USD 231 por pessoa",
        summary:
          "Um circuito completo pela Indonésia — de Seminyak a Labuan Bajo (Komodo), passando por Ubud, Gili Trawangan e Nusa Dua — com extensão de 3 noites em Istambul. Voos internacionais com Turkish Airlines, traslados privativos, hotéis selecionados e experiências autorais como o jantar Tugudom, o nascer do sol em Padar e a navegação até Pink Beach.",
        flights: [
          { airline: "Turkish Airlines", flight: "TK016", date: "25/JUN", from: "Guarulhos (São Paulo)", to: "Istambul", departure: "04:10", arrival: "22:45", arrivalDate: "25/JUN" },
          { airline: "Turkish Airlines", flight: "TK066", date: "26/JUN", from: "Istambul", to: "Denpasar (Bali)", departure: "01:20", arrival: "19:05", arrivalDate: "26/JUN" },
          { airline: "Turkish Airlines", flight: "TK067", date: "11/JUL", from: "Denpasar (Bali)", to: "Istambul", departure: "20:45", arrival: "04:45", arrivalDate: "12/JUL" },
          { airline: "Turkish Airlines", flight: "TK015", date: "14/JUL", from: "Istambul", to: "Guarulhos (São Paulo)", departure: "10:25", arrival: "17:45", arrivalDate: "14/JUL" }
        ],
        airTicketNote: "Passagem aérea internacional em classe econômica com Turkish Airlines — tarifa com taxas a partir de USD 3.181 por pessoa (sujeita a disponibilidade e variação cambial).",
        days: [
          { day: "1", date: "26/06 (Sex)", location: "Denpasar → Seminyak", description: "Chegada em Denpasar, recepção e traslado privativo ao hotel em Seminyak. Acomodação por 3 noites, com café da manhã." },
          { day: "2", date: "27/06 (Sáb)", location: "Seminyak", description: "Manhã livre. À tarde, passeio privativo ao Templo Tanah Lot para o pôr do sol sobre o Índico, seguido de jantar Tugudom — experiência gastronômica teatral inspirada nos antigos banquetes reais do arquipélago indonésio (sem bebidas)." },
          { day: "3", date: "28/06 (Dom)", location: "Seminyak", description: "Café da manhã e dia livre para descanso, praia ou experiências opcionais." },
          { day: "4", date: "29/06 (Seg)", location: "Seminyak → Labuan Bajo", description: "Traslado privativo a Denpasar e voo doméstico a Labuan Bajo. Recepção e traslado ao hotel. Acomodação por 3 noites, com café da manhã." },
          { day: "5", date: "30/06 (Ter)", location: "Padar & Komodo", description: "Saída às 5h30 em speedboat à Ilha de Padar para o nascer do sol e caminhada panorâmica. Sequência até a Ilha de Komodo para avistar os dragões com guarda local. Almoço lunchbox a bordo e mergulho em Pink Beach. Retorno e visita ao mercado noturno de peixes Kampung Ujung." },
          { day: "6", date: "01/07 (Qua)", location: "Labuan Bajo", description: "Café da manhã e dia livre." },
          { day: "7", date: "02/07 (Qui)", location: "Labuan Bajo → Ubud", description: "Passeio de meio dia por Labuan Bajo, incluindo mercado local e a Mirror Cave (Batu Cermin). Voo de retorno a Denpasar e traslado privativo a Ubud. Acomodação por 3 noites, com café da manhã." },
          { day: "8", date: "03/07 (Sex)", location: "Ubud — Tampaksiring", description: "Caminhada pela vila de Tampaksiring entre arrozais e plantações, seguida de aula prática de culinária balinesa em composto tradicional, finalizando com a refeição preparada pelo viajante." },
          { day: "9", date: "04/07 (Sáb)", location: "Ubud — passeio de bicicleta", description: "Trajeto Vila Petang → Carangsari → Taman Punggul → Templo Mumbul na Vila Bongkasa, atravessando arrozais, plantações e vilas balinesas. Bicicleta manual; e-bike sujeita a disponibilidade." },
          { day: "10", date: "05/07 (Dom)", location: "Ubud → Gili Trawangan", description: "Traslado privativo a Padang Bai e speedboat compartilhado a Gili Trawangan. Recepção e traslado em cidomo (carruagem tradicional) ao hotel. Acomodação por 4 noites, com café da manhã." },
          { day: "11", date: "06/07 (Seg)", location: "Gili Trawangan — snorkel pelas três Gilis", description: "Passeio de barco para snorkel nas três ilhas Gili, com recifes de corais, tartarugas e estátuas subaquáticas. Almoço em restaurante local (sem bebidas)." },
          { day: "12", date: "07/07 (Ter)", location: "Gili Trawangan", description: "Café da manhã e dia livre." },
          { day: "13", date: "08/07 (Qua)", location: "Gili Trawangan", description: "Café da manhã e dia livre." },
          { day: "14", date: "09/07 (Qui)", location: "Gili Trawangan → Nusa Dua", description: "Traslado em cidomo ao porto, speedboat compartilhado ao píer de Serangan e traslado privativo ao hotel em Nusa Dua. Acomodação por 2 noites, com café da manhã." },
          { day: "15", date: "10/07 (Sex)", location: "Nusa Dua", description: "Café da manhã e dia livre." },
          { day: "16", date: "11/07 (Sáb)", location: "Nusa Dua → Istambul", description: "Café da manhã e traslado privativo ao aeroporto de Denpasar. Embarque com destino à Turquia." },
          { day: "17", date: "12/07 (Dom)", location: "Istambul", description: "Chegada de madrugada, recepção e traslado privativo ao hotel. Café da manhã e dia livre." },
          { day: "18", date: "13/07 (Seg)", location: "Istambul — tour clássico", description: "Passeio privativo de dia inteiro com guia em português: Mesquita Azul, Hagia Sophia, Hipódromo, Palácio Topkapi e Grand Bazar." },
          { day: "19", date: "14/07 (Ter)", location: "Istambul", description: "Café da manhã, check-out e traslado privativo ao aeroporto. Fim dos nossos serviços." }
        ],
        hotels: [
          { city: "Seminyak", hotel: "The Space Villa Seminyak", nights: 3, category: "Superior", room: "Two Bedroom Villa", includes: "Café da manhã" },
          { city: "Labuan Bajo", hotel: "Plataran Resort Komodo", nights: 3, category: "Superior", room: "Two Bedroom Beachfront Residence", includes: "Café da manhã" },
          { city: "Ubud", hotel: "Como Uma Ubud", nights: 3, category: "Luxo", room: "One Bedroom Garden Pool Villa", includes: "Café da manhã" },
          { city: "Gili Trawangan", hotel: "Pondok Santi Estate", nights: 4, category: "Superior", room: "Lake View Villa", includes: "Café da manhã" },
          { city: "Nusa Dua", hotel: "The Laguna, A Luxury Collection Resort and Spa", nights: 2, category: "Superior+", room: "Deluxe Studio Lagoon Access", includes: "Café da manhã" },
          { city: "Istambul", hotel: "The Marmara Taksim", nights: 3, category: "Superior", room: "Bosphorus Suite Sea View", includes: "Café da manhã" }
        ],
        includes: [
          "Passagem aérea internacional em classe econômica com Turkish Airlines (GRU / Denpasar / Istambul / GRU)",
          "Passagem aérea doméstica Denpasar / Labuan Bajo / Denpasar em classe econômica, taxas incluídas (1 mala despachada de 20kg por pessoa)",
          "Hospedagem: 3 noites Seminyak, 3 noites Labuan Bajo, 3 noites Ubud, 4 noites Gili Trawangan, 2 noites Nusa Dua, 3 noites Istambul — todas com café da manhã",
          "Traslados e passeios privativos conforme roteiro, com guias/assistências locais em inglês",
          "Traslados em Gili Trawangan em cidomo (carruagem tradicional puxada por cavalos)",
          "Barco rápido regular entre Padang Bai – Gili Trawangan – Serangan",
          "Todas as entradas aos locais de visita mencionados",
          "Refeições conforme mencionadas no roteiro (sem bebidas)",
          "Passeio privativo de dia inteiro em Istambul com guia em português",
          "Kit de viagem Create Travel"
        ],
        excludes: [
          "Taxas de embarque e taxas de turismo",
          "Despesas com documentação e vistos consulares",
          "Seguro viagem e seguro cancelamento",
          "Excesso de bagagem",
          "Early check-in e late check-out",
          "Refeições e bebidas não mencionadas como incluídas",
          "Gorjetas e serviço de maleteiro",
          "Passeios, excursões e entradas opcionais",
          "Reservas de restaurantes (taxa de USD 10 a USD 30)",
          "Despesas de caráter pessoal (lavanderia, telefonemas, minibar, etc.)"
        ],
        notes: [
          "Os traslados em Gili Trawangan são realizados em cidomo pois veículos motorizados não são permitidos na ilha.",
          "Indonésia — passaporte com validade mínima de 6 meses e 2 páginas em branco. Brasileiros não precisam de visto antecipado. É obrigatório o cartão internacional de vacina contra febre amarela (aplicação até 10 dias antes do embarque).",
          "Turquia — passaporte com validade mínima de 6 meses e 2 páginas em branco. Brasileiros não precisam de visto antecipado. Vacina de febre amarela não obrigatória.",
          "Valores sujeitos a disponibilidade no momento da reserva e variação cambial."
        ]
      }
    ]
  },
