...
export const ADVENTURE_ACTIVITIES: AdventureActivity[] = [
  ...
  {
    id: "quadriciclo",
    image: quadricicloImg,
    intensity: "moderada",
    i18n: {
      pt: {
        name: "Quadriciclo nas dunas",
        tagline: "Acelerar entre dunas, lagoas e o pôr do sol",
        description: "Quadriciclos 4x4 cruzando campos de dunas brancas, lagoas de água doce e vilarejos de pescadores. Em Jericoacoara você termina no Pôr do Sol da Duna; nos Lençóis, a travessia liga oásis improváveis. Capacete, briefing e guia em comboio.",
        season: "Julho a janeiro (alísios e dunas firmes)",
        where: "Jericoacoara (CE) · Lençóis Maranhenses (MA) · Atins (MA) · Genipabu (RN)",
      },
      en: {
        name: "ATV dune ride",
        tagline: "Throttle through dunes, lagoons and sunsets",
        description: "4x4 quad bikes crossing white-sand dune fields, freshwater lagoons and fishing villages. In Jericoacoara you finish at Sunset Dune; in Lençóis, the crossing links improbable oases. Helmet, briefing and guided convoy.",
        season: "July to January (trade winds, firm dunes)",
        where: "Jericoacoara (CE) · Lençóis Maranhenses (MA) · Atins (MA) · Genipabu (RN)",
      },
      es: {
        name: "Cuatriciclo en las dunas",
        tagline: "Acelerar entre dunas, lagunas y el atardecer",
        description: "Cuatriciclos 4x4 cruzando campos de dunas blancas, lagunas de agua dulce y aldeas de pescadores. En Jericoacoara terminas en la Duna del Atardecer; en los Lençóis, la travesía une oasis improbables.",
        season: "Julio a enero (alisios y dunas firmes)",
        where: "Jericoacoara (CE) · Lençóis Maranhenses (MA) · Atins (MA) · Genipabu (RN)",
      },
      it: {
        name: "Quad sulle dune",
        tagline: "Accelerare tra dune, lagune e tramonti",
        description: "Quad 4x4 attraverso campi di dune bianche, lagune di acqua dolce e villaggi di pescatori. A Jericoacoara si finisce alla Duna del Tramonto; nei Lençóis la traversata collega oasi improbabili.",
        season: "Luglio-gennaio (alisei e dune compatte)",
        where: "Jericoacoara (CE) · Lençóis Maranhenses (MA) · Atins (MA) · Genipabu (RN)",
      },
      de: {
        name: "Quad in den Dünen",
        tagline: "Gas geben zwischen Dünen, Lagunen und Sonnenuntergang",
        description: "4x4-Quads durch weiße Dünenfelder, Süßwasserlagunen und Fischerdörfer. In Jericoacoara endet die Tour an der Sonnenuntergangs-Düne; in den Lençóis verbindet sie unwahrscheinliche Oasen.",
        season: "Juli bis Januar (Passatwinde, feste Dünen)",
        where: "Jericoacoara (CE) · Lençóis Maranhenses (MA) · Atins (MA) · Genipabu (RN)",
      },
    },
  },
  {
    ...
    i18n: {
      pt: {
        name: "Cavalgada pantaneira",
        tagline: "O bioma no ritmo dos cascos",
        description: "Acompanhar uma comitiva pantaneira ao amanhecer, cruzando campos alagados onde tuiuiús levantam voo e capivaras se afastam sem pressa. Cavalos mansos e adaptados ao terreno; também há cavalgadas em fazendas históricas da Serra da Mantiqueira e nas praias de Atins.",
        season: "Pantanal: maio-out · Mantiqueira: ano todo · Atins: jul-jan",
        where: "Pantanal (MS/MT) — Caiman, Barranco Alto · Mantiqueira (MG/SP) · Atins (MA) · Chapada dos Veadeiros (GO)",
      },
      en: {
        name: "Pantanal horseback ride",
        tagline: "The biome at hoof-rhythm",
        description: "Joining a Pantanal cattle ride at dawn, crossing flooded plains where jabiru storks take flight and capybaras drift aside. Calm horses adapted to the terrain; also historic-ranch rides in the Mantiqueira range and beach rides in Atins.",
        season: "Pantanal: May-Oct · Mantiqueira: year-round · Atins: Jul-Jan",
        where: "Pantanal (MS/MT) — Caiman, Barranco Alto · Mantiqueira (MG/SP) · Atins (MA) · Chapada dos Veadeiros (GO)",
      },
      es: {
        name: "Cabalgata pantanera",
        tagline: "El bioma al ritmo de los cascos",
        description: "Acompañar una comitiva pantanera al amanecer, cruzando campos inundados donde los tuiuiús levantan vuelo y los capibaras se apartan sin prisa. Caballos mansos adaptados al terreno.",
        season: "Pantanal: may-oct · Mantiqueira: todo el año · Atins: jul-ene",
        where: "Pantanal (MS/MT) · Mantiqueira (MG/SP) · Atins (MA) · Chapada dos Veadeiros (GO)",
      },
      it: {
        name: "Cavalcata nel Pantanal",
        tagline: "Il bioma al ritmo degli zoccoli",
        description: "Accompagnare una comitiva pantaneira all'alba, attraversando campi allagati dove i jabiru spiccano il volo e i capibara si scostano senza fretta. Cavalli mansueti adattati al terreno.",
        season: "Pantanal: mag-ott · Mantiqueira: tutto l'anno · Atins: lug-gen",
        where: "Pantanal (MS/MT) · Mantiqueira (MG/SP) · Atins (MA) · Chapada dos Veadeiros (GO)",
      },
      de: {
        name: "Reiten im Pantanal",
        tagline: "Das Biom im Takt der Hufe",
        description: "Im Morgengrauen mit einem Pantanal-Treck überflutete Ebenen durchqueren, wo Jabiru-Störche auffliegen und Capybaras ohne Eile zur Seite gehen. Sanfte, geländegängige Pferde.",
        season: "Pantanal: Mai-Okt · Mantiqueira: ganzjährig · Atins: Jul-Jan",
        where: "Pantanal (MS/MT) · Mantiqueira (MG/SP) · Atins (MA) · Chapada dos Veadeiros (GO)",
      },
    },
  },
  {
    ...
    i18n: {
      pt: {
        name: "Canionismo",
        tagline: "Descer um cânion por dentro, na água viva",
        description: "Combina rapel, nadando em poços, escorregando em toboágua naturais e saltos em cachoeiras. É a aventura completa, dentro de paredões esculpidos por milhões de anos. Equipamento técnico (capacete, neoprene, cadeirinha) e guia ACG/ABETA obrigatórios.",
        season: "Maio a outubro (águas mais seguras)",
        where: "Chapada das Mesas (MA) · Bonito (MS) — Boca da Onça · Cavalcante (GO) · Petrópolis (RJ) — Cânion das Andorinhas",
      },
      en: {
        name: "Canyoning",
        tagline: "Descend a canyon from the inside, in living water",
        description: "Combines rappel, swimming through pools, sliding down natural waterslides and jumping into cascades. The complete adventure, deep inside walls carved over millions of years. Technical gear and ACG/ABETA guide mandatory.",
        season: "May to October (safer water levels)",
        where: "Chapada das Mesas (MA) · Bonito (MS) — Boca da Onça · Cavalcante (GO) · Petrópolis (RJ)",
      },
      es: {
        name: "Barranquismo",
        tagline: "Bajar un cañón por dentro, en agua viva",
        description: "Combina rapel, natación en pozos, toboganes naturales y saltos en cascadas. La aventura completa, dentro de paredones esculpidos por millones de años. Equipo técnico y guía certificado obligatorios.",
        season: "Mayo a octubre (aguas más seguras)",
        where: "Chapada das Mesas (MA) · Bonito (MS) — Boca da Onça · Cavalcante (GO) · Petrópolis (RJ)",
      },
      it: {
        name: "Canyoning",
        tagline: "Scendere un canyon dall'interno, nell'acqua viva",
        description: "Combina corda doppia, nuoto in pozze, scivoli naturali e salti in cascata. L'avventura completa, dentro pareti scolpite in milioni di anni. Attrezzatura tecnica e guida certificata obbligatorie.",
        season: "Maggio-ottobre (acque più sicure)",
        where: "Chapada das Mesas (MA) · Bonito (MS) — Boca da Onça · Cavalcante (GO) · Petrópolis (RJ)",
      },
      de: {
        name: "Canyoning",
        tagline: "Eine Schlucht von innen abfahren, im lebendigen Wasser",
        description: "Kombiniert Abseilen, Schwimmen durch Becken, natürliche Wasserrutschen und Sprünge in Wasserfälle. Das komplette Abenteuer, in Wänden, die über Millionen Jahre geformt wurden.",
        season: "Mai bis Oktober (sicherere Wasserstände)",
        where: "Chapada das Mesas (MA) · Bonito (MS) — Boca da Onça · Cavalcante (GO) · Petrópolis (RJ)",
      },
    },
  },
  {
    ...
    i18n: {
      pt: {
        name: "Mergulho — Noronha, Abrolhos e Bonito",
        tagline: "Tartarugas, jubartes e o azul que parece céu",
        description: "Em Fernando de Noronha, mergulho de cilindro com tubarões-lixa, tartarugas e arraias em visibilidade de 30 m. Em Abrolhos, encontro com baleias-jubarte (julho a novembro). Em Bonito, snorkel em grutas de águas azuis surreais. Batismo para iniciantes; cursos PADI/Open Water disponíveis.",
        season: "Noronha: ago-mar · Abrolhos: jul-nov · Bonito: ano todo",
        where: "Fernando de Noronha (PE) · Abrolhos (BA) · Bonito (MS) — Gruta do Lago Azul · Ilha Grande (RJ) · Ilhabela (SP)",
      },
      en: {
        name: "Scuba diving — Noronha, Abrolhos & Bonito",
        tagline: "Turtles, humpbacks and a blue that feels like sky",
        description: "Fernando de Noronha: tank dives with nurse sharks, sea turtles and rays in 30-m visibility. Abrolhos: encounters with humpback whales (July-November). Bonito: snorkeling in surreal blue-water caves. Discovery dives for beginners; PADI Open Water courses available.",
        season: "Noronha: Aug-Mar · Abrolhos: Jul-Nov · Bonito: year-round",
        where: "Fernando de Noronha (PE) · Abrolhos (BA) · Bonito (MS) · Ilha Grande (RJ) · Ilhabela (SP)",
      },
      es: {
        name: "Buceo — Noronha, Abrolhos y Bonito",
        tagline: "Tortugas, jorobadas y el azul que parece cielo",
        description: "En Fernando de Noronha, buceo con tiburones gata, tortugas y rayas con 30 m de visibilidad. En Abrolhos, encuentro con ballenas jorobadas (julio-noviembre). En Bonito, snorkel en grutas surrealistas.",
        season: "Noronha: ago-mar · Abrolhos: jul-nov · Bonito: todo el año",
        where: "Fernando de Noronha (PE) · Abrolhos (BA) · Bonito (MS) · Ilha Grande (RJ)",
      },
      it: {
        name: "Immersioni — Noronha, Abrolhos e Bonito",
        tagline: "Tartarughe, megattere e un azzurro che sembra cielo",
        description: "A Fernando de Noronha, immersioni con squali nutrice, tartarughe e razze con 30 m di visibilità. Ad Abrolhos, incontro con megattere (luglio-novembre). A Bonito, snorkeling in grotte di acqua blu surreale.",
        season: "Noronha: ago-mar · Abrolhos: lug-nov · Bonito: tutto l'anno",
        where: "Fernando de Noronha (PE) · Abrolhos (BA) · Bonito (MS) · Ilha Grande (RJ)",
      },
      de: {
        name: "Tauchen — Noronha, Abrolhos & Bonito",
        tagline: "Schildkröten, Buckelwale und ein Blau wie der Himmel",
        description: "In Fernando de Noronha Flaschen-Tauchgänge mit Ammenhaien, Schildkröten und Rochen bei 30 m Sicht. In Abrolhos Begegnungen mit Buckelwalen (Juli-November). In Bonito Schnorcheln in surrealen Blauwasserhöhlen.",
        season: "Noronha: Aug-Mär · Abrolhos: Jul-Nov · Bonito: ganzjährig",
        where: "Fernando de Noronha (PE) · Abrolhos (BA) · Bonito (MS) · Ilha Grande (RJ)",
      },
    },
  },
  {
    ...
    i18n: {
      pt: {
        ...
        tagline: "Pedalar por estradas reais, serras e cerrado",
        description: "Da Estrada Real (caminhos coloniais entre Minas e Rio) aos single tracks da Serra do Cipó, do circuito do vinho na Serra Gaúcha às trilhas de cerrado dos Veadeiros. Bicicletas alugadas, batalhão de apoio (carro vassoura, mecânico, hidratação), pousadas charmosas a cada etapa.",
        season: "Abril a setembro (secas e amenas)",
        where: "Estrada Real (MG/RJ) · Serra do Cipó (MG) · Chapada dos Veadeiros (GO) · Serra Gaúcha (RS) — Vale dos Vinhedos",
      },
      en: {
        name: "Cycling & mountain biking",
        tagline: "Pedal royal roads, sierras and cerrado",
        description: "From the Estrada Real (colonial routes between Minas and Rio) to Serra do Cipó singletracks, the Gaucho wine circuit to the cerrado trails of Veadeiros. Rental bikes, full support (sweep car, mechanic, hydration), charming inns at each stage.",
        season: "April to September (dry and mild)",
        where: "Estrada Real (MG/RJ) · Serra do Cipó (MG) · Chapada dos Veadeiros (GO) · Serra Gaúcha (RS) — wine valley",
      },
      es: {
        name: "Cicloturismo y mountain bike",
        tagline: "Pedalear por caminos reales, sierras y cerrado",
        description: "De la Estrada Real (caminos coloniales entre Minas y Río) a los senderos de Serra do Cipó, del circuito del vino en la Serra Gaúcha a las trillas de cerrado de Veadeiros. Apoyo completo y posadas en cada etapa.",
        season: "Abril a septiembre (secas y templadas)",
        where: "Estrada Real (MG/RJ) · Serra do Cipó (MG) · Chapada dos Veadeiros (GO) · Serra Gaúcha (RS)",
      },
      it: {
        name: "Cicloturismo e mountain bike",
        tagline: "Pedalare strade reali, sierre e cerrado",
        description: "Dall'Estrada Real (vie coloniali tra Minas e Rio) ai single track della Serra do Cipó, dal circuito del vino della Serra Gaucha ai sentieri del cerrado di Veadeiros. Supporto completo e locande a ogni tappa.",
        season: "Aprile-settembre (asciutto e mite)",
        where: "Estrada Real (MG/RJ) · Serra do Cipó (MG) · Chapada dos Veadeiros (GO) · Serra Gaúcha (RS)",
      },
      de: {
        name: "Radreisen & Mountainbike",
        tagline: "Königswege, Bergketten und Cerrado strampeln",
        description: "Von der Estrada Real (Kolonialwege zwischen Minas und Rio) zu den Singletracks der Serra do Cipó, vom Weinkreis der Serra Gaúcha zu den Cerrado-Pfaden von Veadeiros. Volle Begleitung und charmante Gasthäuser an jeder Etappe.",
        season: "April bis September (trocken und mild)",
        where: "Estrada Real (MG/RJ) · Serra do Cipó (MG) · Chapada dos Veadeiros (GO) · Serra Gaúcha (RS)",
      },
    },
  },
  {
    id: "caiaque-oceanico",
    image: caiaqueOceanicoImg,
    intensity: "intensa",
    i18n: {
      pt: {
        name: "Expedição de caiaque oceânico",
        tagline: "Atravessar enseadas que só se alcançam pela água",
        description: "Caiaques sit-on-top em travessias de 2 a 5 dias entre ilhas, praias desertas e manguezais. Na Costa do Cacau cruzamos a Baía de Camamu de ilha em ilha; em Paraty entramos no Saco do Mamanguá; no Delta do Parnaíba navegamos labirintos de água. Apoio com barco-mãe e bivouac em praias.",
        season: "Costa do Cacau: ago-mar · Paraty: abr-out · Delta: jul-nov",
        where: "Baía de Camamu (BA) — Maraú · Paraty (RJ) — Mamanguá · Delta do Parnaíba (PI/MA) · Angra dos Reis (RJ)",
      },
      en: {
        name: "Sea-kayak expedition",
        tagline: "Cross bays only reachable from the water",
        description: "Sit-on-top kayaks on 2 to 5-day crossings between islands, deserted beaches and mangroves. On the Cacau Coast we hop islands across Camamu Bay; in Paraty we enter Mamanguá fjord; in the Parnaíba Delta we navigate water labyrinths. Support boat and beach bivouac.",
        season: "Cacau Coast: Aug-Mar · Paraty: Apr-Oct · Delta: Jul-Nov",
        where: "Camamu Bay (BA) — Maraú · Paraty (RJ) — Mamanguá · Parnaíba Delta (PI/MA) · Angra dos Reis (RJ)",
      },
      es: {
        name: "Expedición en kayak oceánico",
        tagline: "Atravesar ensenadas a las que solo se llega por agua",
        description: "Kayaks sit-on-top en travesías de 2 a 5 días entre islas, playas desiertas y manglares. En la Costa del Cacao cruzamos la Bahía de Camamu; en Paraty entramos al Saco do Mamanguá. Apoyo con barco madre.",
        season: "Costa do Cacau: ago-mar · Paraty: abr-oct · Delta: jul-nov",
        where: "Bahía de Camamu (BA) · Paraty (RJ) — Mamanguá · Delta do Parnaíba (PI/MA) · Angra dos Reis (RJ)",
      },
      it: {
        name: "Spedizione in kayak oceanico",
        tagline: "Attraversare insenature raggiungibili solo dall'acqua",
        description: "Kayak sit-on-top in traversate di 2-5 giorni tra isole, spiagge deserte e mangrovie. Sulla Costa del Cacao saltiamo di isola in isola nella Baia di Camamu; a Paraty entriamo nel fiordo di Mamanguá. Barca di appoggio e bivacco in spiaggia.",
        season: "Costa do Cacau: ago-mar · Paraty: apr-ott · Delta: lug-nov",
        where: "Baia di Camamu (BA) · Paraty (RJ) · Delta do Parnaíba (PI/MA) · Angra dos Reis (RJ)",
      },
      de: {
        name: "Seekajak-Expedition",
        tagline: "Buchten durchqueren, die nur vom Wasser aus erreichbar sind",
        description: "Sit-on-top-Kajaks auf 2- bis 5-tägigen Überfahrten zwischen Inseln, einsamen Stränden und Mangroven. An der Cacau-Küste springen wir von Insel zu Insel durch die Camamu-Bucht; in Paraty geht es in den Mamanguá-Fjord. Begleitboot und Strand-Biwak.",
        season: "Cacau-Küste: Aug-Mär · Paraty: Apr-Okt · Delta: Jul-Nov",
        where: "Camamu-Bucht (BA) · Paraty (RJ) · Parnaíba-Delta (PI/MA) · Angra dos Reis (RJ)",
      },
    },
  },
  {
    ...
    i18n: {
      pt: {
        name: "Parapente e voo livre",
        tagline: "Decolar da Pedra Bonita e pousar na praia",
        description: "Voo duplo com piloto certificado: você corre alguns passos, e em 5 segundos está flutuando a 500 m do mar. Voa-se da Pedra Bonita pousando em São Conrado (RJ); de Governador Valadares (MG, a 'capital do voo livre'); e da rampa de Castelo (ES) sobre a Mata Atlântica.",
        season: "Rio: abr-set · Valadares: ano todo · Castelo: mai-set",
        where: "Pedra Bonita / São Conrado (RJ) · Governador Valadares (MG) · Castelo (ES) · Bauru (SP)",
      },
      en: {
        name: "Paragliding",
        tagline: "Launch from Pedra Bonita, land on the beach",
        description: "Tandem flight with a certified pilot: you run a few steps, and in 5 seconds you're floating 500 m above the sea. Launch from Pedra Bonita and land in São Conrado (Rio); fly from Governador Valadares (Brazil's 'free-flight capital'); or from Castelo (ES) over the Atlantic Forest.",
        season: "Rio: Apr-Sep · Valadares: year-round · Castelo: May-Sep",
        where: "Pedra Bonita / São Conrado (RJ) · Governador Valadares (MG) · Castelo (ES) · Bauru (SP)",
      },
      es: {
        name: "Parapente y vuelo libre",
        tagline: "Despegar de Pedra Bonita y aterrizar en la playa",
        description: "Vuelo doble con piloto certificado: corres unos pasos y en 5 segundos flotas a 500 m del mar. Se vuela desde Pedra Bonita aterrizando en São Conrado (Río); desde Governador Valadares (capital del vuelo libre).",
        season: "Río: abr-sep · Valadares: todo el año",
        where: "Pedra Bonita / São Conrado (RJ) · Governador Valadares (MG) · Castelo (ES)",
      },
      it: {
        name: "Parapendio e volo libero",
        tagline: "Decollare da Pedra Bonita e atterrare in spiaggia",
        description: "Volo biposto con pilota certificato: corri qualche passo e in 5 secondi galleggi a 500 m sul mare. Si vola da Pedra Bonita atterrando a São Conrado (Rio); da Governador Valadares (capitale del volo libero).",
        season: "Rio: apr-set · Valadares: tutto l'anno",
        where: "Pedra Bonita / São Conrado (RJ) · Governador Valadares (MG) · Castelo (ES)",
      },
      de: {
        name: "Gleitschirmfliegen",
        tagline: "Vom Pedra Bonita starten, am Strand landen",
        description: "Tandemflug mit zertifiziertem Piloten: ein paar Schritte Anlauf, und nach 5 Sekunden schwebst du 500 m über dem Meer. Start von Pedra Bonita, Landung in São Conrado (Rio); Flüge ab Governador Valadares (Brasiliens 'Hauptstadt des Freiflugs').",
        season: "Rio: Apr-Sep · Valadares: ganzjährig",
        where: "Pedra Bonita / São Conrado (RJ) · Governador Valadares (MG) · Castelo (ES)",
      },
    },
  },
  {
    id: "espeleologia",
    image: espeleologiaImg,
    intensity: "moderada",
    i18n: {
      pt: {
        name: "Espeleologia — cavernas e abismos",
        tagline: "Entrar no Brasil que ninguém vê",
        description: "Travessias de cavernas com rios subterrâneos, salões de 100 m de pé-direito e formações de calcita iluminadas pela lanterna do capacete. No PETAR atravessamos a Caverna Santana; no Peruaçu visitamos as catedrais sagradas da pré-história; em Bonito mergulhamos na Abismo Anhumas (mergulho em poço de 80 m).",
        season: "Maio a outubro (rios subterrâneos seguros)",
        where: "Peruaçu (MG) · PETAR (SP) — Vale do Ribeira · Bonito (MS) — Abismo Anhumas · Chapada Diamantina (BA) — Lapa Doce",
      },
      en: {
        name: "Caving — caves & sinkholes",
        tagline: "Step into the Brazil no one sees",
        description: "Cave traverses with underground rivers, 100-m-high chambers and calcite formations lit only by your helmet lamp. PETAR's Santana cave; Peruaçu's prehistoric cathedrals; Bonito's Abismo Anhumas (rappel into an 80-m sinkhole with diving below).",
        season: "May to October (safe underground waters)",
        where: "Peruaçu (MG) · PETAR (SP) — Ribeira Valley · Bonito (MS) — Abismo Anhumas · Chapada Diamantina (BA) — Lapa Doce",
      },
      es: {
        name: "Espeleología — cuevas y abismos",
        tagline: "Entrar en el Brasil que nadie ve",
        description: "Travesías de cuevas con ríos subterráneos, salones de 100 m de altura y formaciones de calcita iluminadas por la linterna del casco. En el PETAR la Caverna Santana; en Peruaçu las catedrales prehistóricas; en Bonito el Abismo Anhumas.",
        season: "Mayo a octubre (aguas subterráneas seguras)",
        where: "Peruaçu (MG) · PETAR (SP) · Bonito (MS) — Abismo Anhumas · Chapada Diamantina (BA)",
      },
      it: {
        name: "Speleologia — grotte e abissi",
        tagline: "Entrare nel Brasile che nessuno vede",
        description: "Traversate di grotte con fiumi sotterranei, sale di 100 m di altezza e formazioni di calcite illuminate solo dalla lampada del casco. Al PETAR la Grotta Santana; a Peruaçu le cattedrali preistoriche; a Bonito l'Abismo Anhumas.",
        season: "Maggio-ottobre (acque sotterranee sicure)",
        where: "Peruaçu (MG) · PETAR (SP) · Bonito (MS) — Abismo Anhumas · Chapada Diamantina (BA)",
      },
      de: {
        name: "Höhlenforschung — Grotten & Schlote",
        tagline: "Das Brasilien betreten, das niemand sieht",
        description: "Höhlendurchquerungen mit unterirdischen Flüssen, 100 m hohen Hallen und Kalzitformationen, nur von der Stirnlampe beleuchtet. Im PETAR die Santana-Höhle; in Peruaçu die prähistorischen Kathedralen; in Bonito der Abismo Anhumas.",
        season: "Mai bis Oktober (sichere unterirdische Gewässer)",
        where: "Peruaçu (MG) · PETAR (SP) · Bonito (MS) — Abismo Anhumas · Chapada Diamantina (BA)",
      },
    },
  },
