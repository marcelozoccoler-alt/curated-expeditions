...
const localGuideGroupsCore: LocalGuideGroup[] = [
  ...
  },
  {
    ...
    "subtitle": "Viena · Budapeste · Bratislava · Praga",
    "intro": "As mesmas quatro capitais imperiais em versão Primeira: Viena, Budapeste, Bratislava e Praga com o essencial preservado — cafés históricos, pontes iluminadas e centros a pé — em uma seleção de hotelaria mais discreta, para quem prefere concentrar o investimento nas experiências.",
    "highlights": ["Viena imperial: Hofburg, Ópera e Ringstrasse", "Budapeste vista do Bastião dos Pescadores", "Bratislava em caminhada pelo centro medieval", "Praga: Castelo, Malá Strana e Ponte Carlos", "Ônibus moderno com áudio individual", "Curadoria de conteúdo em cada cidade"],
    "category": "Primeira",
    "days": 9,
    "nights": 8,
    "priceEur": 1695,
  ...
  },
  {
    ...
    "subtitle": "Viena · Budapeste · Praga · Dresden · Berlim",
    "intro": "De Viena a Berlim em onze dias, atravessando cinco cidades que contam a Europa do império ao muro. Versão Primeira: mesmo roteiro, mesma profundidade, hotelaria de perfil mais discreto.",
    "highlights": ["Cinco cidades históricas em um só circuito", "Dresden e o Elba entre Praga e Berlim", "Berlim contemporânea com guia local", "Centro de Praga a pé, do castelo ao rio", "Budapeste em dois dias", "Saídas garantidas em datas fixas"],
    "category": "Primeira",
    "days": 11,
    "nights": 10,
    "priceEur": 2125,
