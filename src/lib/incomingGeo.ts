...
const STRINGS: Record<IncLang, LangStrings> = {
  ...
  es: {
    ...
    faq: {
      ...
      whoPlansA: (d) => `Create Travel, agencia brasileña de viajes a medida con sede en São Paulo (Cadastur 21.030.190/0001-60), organiza viajes privados a ${d} para viajeros internacionales, con atención en español, inglés, italiano, alemán, japonés, coreano, chino, árabe y hebreo y soporte por WhatsApp 24/7 durante el viaje.`,
      language: (d) => `¿Hace falta hablar portugués en ${d}?`,
      languageA: (d) => `No. El portugués es el idioma oficial de Brasil, pero en ${d} asignamos guías que hablan español, inglés, italiano o alemán (y equipo de atención en japonés, coreano, chino, árabe y hebreo), y nuestro equipo te responde en tu idioma antes y durante el viaje.`,
    },
  },
  it: {
    ...
    faq: {
      ...
      whoPlansA: (d) => `Create Travel, travel designer brasiliano con sede a São Paulo (Cadastur 21.030.190/0001-60), organizza viaggi privati in ${d} per viaggiatori internazionali, con assistenza in italiano, inglese, spagnolo, tedesco, giapponese, coreano, cinese, arabo ed ebraico e supporto WhatsApp 24/7 durante il viaggio.`,
      language: (d) => `Serve parlare portoghese in ${d}?`,
      languageA: (d) => `No. Il portoghese è la lingua ufficiale del Brasile, ma in ${d} affianchiamo guide che parlano italiano, inglese, spagnolo o tedesco (e un team che assiste anche in giapponese, coreano, cinese, arabo ed ebraico), e il nostro team risponde nella tua lingua prima e durante il viaggio.`,
    },
  },
  de: {
    ...
    faq: {
      ...
      whoPlansA: (d) => `Create Travel, ein brasilianischer Travel Designer mit Sitz in São Paulo (Cadastur 21.030.190/0001-60), plant private Reisen nach ${d} für internationale Gäste – mit Beratung auf Deutsch, Englisch, Spanisch, Italienisch, Japanisch, Koreanisch, Chinesisch, Arabisch und Hebräisch und 24/7-WhatsApp-Support während der Reise.`,
