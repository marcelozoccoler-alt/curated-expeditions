...
export const buildPlaceKeywords = (
  ...
  return dedupe([
    ...
    `viagem ${placeName}`,
    `viagem para ${placeName}`,
    `passagem para ${placeName}`,
    `voos para ${placeName}`,
    `hotel em ${placeName}`,
    `hospedagem em ${placeName}`,
    `quanto custa viagem para ${placeName}`,
    `quanto custa pacote de viagem para ${placeName}`,
