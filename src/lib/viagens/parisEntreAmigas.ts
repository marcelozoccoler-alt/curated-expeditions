...
const ROTAS_BASE: RotaHotel[] = [
  {
    ...
    enderecoVisivel: "Lado direito do Arco do Carrossel, em frente à Pirâmide — jaqueta vermelha da Extime Travel",
  ...
  },
  {
    ...
    enderecoVisivel: "6 Avenue du Dr Brouardel, 75007 Paris — colete vermelho da Extime Travel",
