...
const faqs = [
  ...
  },
  {
    ...
    a: "Grupo com coordenador embarcando de São Paulo e guia local em português. Casais, amigos e viajantes solo são muito bem-vindos. Trabalhamos com apartamento duplo (compartilhado) ou individual (com suplemento).",
  },
];
