...
const faqs = [
  ...
  { q: "Qual é o investimento da viagem?", a: "O programa aéreo + terrestre sai de € 11.050 por pessoa em apartamento duplo, com opção somente terrestre a partir de € 9.372. Há suplemento para apartamento individual e condições especiais para triplo e crianças até 12 anos. Os valores não incluem taxas de embarque e IOF, que aparecem detalhados na seção Investimento. A Create Travel confirma disponibilidade e a proposta atualizada antes da reserva." },
];
