...
const faqs = [
  {
    ...
    a: "25% de entrada no ato da reserva e o saldo (75%) em 9 parcelas sem juros no cartão de crédito. Valores em dólar, por pessoa, sujeitos a disponibilidade e confirmação aérea.",
  },
  {
