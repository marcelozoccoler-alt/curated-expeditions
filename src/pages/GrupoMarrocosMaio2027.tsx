...
const itinerary = [
  ...
  { day: "Dia 7 — 18/05 (ter)", title: "Fez → Ifrane → Midelt → Erfoud", points: ["Travessia do Atlas por Immouzzer Kandar, Ifrane e Azrou", "Bosques de cedros e paisagens berberes", "Vale do Ziz e seus extensos palmeirais", "Chegada a Erfoud · almoço não incluído · jantar incluído"] },
