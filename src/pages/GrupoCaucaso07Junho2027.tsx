...
const CANONICAL = "/grupos/caucaso-07-junho-2027";
const GROUP_NAME = "Grupo Cáucaso — Armênia, Geórgia e Azerbaijão · Saída 07/06/2027 — Create Travel";
const whatsappParams = {
  type: "Roteiro" as const,
  name: "Grupo Cáucaso · Armênia, Geórgia e Azerbaijão (saída 07/06/2027)",
};

const benefits = [
  { title: "Guia acompanhante desde o Brasil", desc: "Encontro em Guarulhos e acompanhamento durante todo o circuito até o retorno." },
  { title: "Três países, uma jornada", desc: "Armênia, Geórgia e Azerbaijão: três identidades surpreendentemente diferentes no coração do Cáucaso." },
...
const itinerary = [
  { day: "Dia 1 — 07/06 (seg)", title: "São Paulo", points: ["Apresentação no Aeroporto Internacional de Guarulhos", "Encontro com o coordenador e preparação para o embarque"] },
  { day: "Dia 2 — 08/06 (ter)", title: "São Paulo → Istambul", points: ["Embarque no voo Turkish Airlines TK 16 às 04h10", "Chegada prevista a Istambul às 22h45"] },
  { day: "Dia 3 — 09/06 (qua)", title: "Istambul → Yerevan", points: ["Conexão no voo TK 360 às 02h00, chegada a Yerevan às 05h15", "Recepção, traslado ao hotel e manhã livre para descanso", "Tarde: visita panorâmica — Praça da República, Complexo Cascade, Parque da Vitória e Monumento à Mãe Armênia", "Matenadarán, centro de manuscritos antigos, e Memorial de Tsitsernakaberd"] },
  { day: "Dia 4 — 10/06 (qui)", title: "Yerevan · Garni · Geghard", points: ["Templo pagão de Garni, do século I d.C., e a Sinfonia de Pedra no cânion do rio Azat", "Aula prática de preparo do lavash, o pão tradicional armênio", "Mosteiro de Geghard, esculpido na rocha — Patrimônio Mundial da UNESCO", "Destilaria de brandy Ararat ou Noy, com degustação", "Opcional: concerto vocal de música espiritual armênia em capela de Geghard"] },
  { day: "Dia 5 — 11/06 (sex)", title: "Yerevan · Khor Virap · Noravank", points: ["Mosteiro de Khor Virap, com o Monte Ararat no horizonte", "Região de Vayots Dzor e a Caverna Areni-1, com a adega mais antiga conhecida (6.100 anos)", "Mosteiro de Noravank, joia do século XIII entre formações avermelhadas", "Retorno a Yerevan"] },
  { day: "Dia 6 — 12/06 (sáb)", title: "Yerevan → Sevan → Dilijan → Haghpat → Tbilisi", points: ["Lago Sevan, a Pérola Azul da Armênia, e o Mosteiro de Sevanavank", "Dilijan, a Suíça Armênia, com centro histórico e ateliês de artesanato", "Mosteiro de Haghpat, Patrimônio Mundial da UNESCO", "Fronteira Bagratashen–Sadakhlo e continuação pela Geórgia até Tbilisi"] },
  { day: "Dia 7 — 13/06 (dom)", title: "Tbilisi", points: ["Caminhada pela parte histórica: Museu Estatal de História, Igreja Metekhi e Basílica de Anchiskhati", "Fortaleza de Narikala e, se o tempo permitir, teleférico até o mirante", "Bairro Abanotubani, dos banhos de enxofre, e vista panorâmica pela Ponte da Paz"] },
  { day: "Dia 8 — 14/06 (seg)", title: "Tbilisi · Mtskheta · Uplistsikhe", points: ["Mtskheta, antiga capital e coração espiritual da Geórgia — Patrimônio Mundial da UNESCO", "Igreja de Jvari e Catedral de Svetitskhoveli", "Uplistsikhe, a cidade caverna esculpida na rocha há mais de 3.000 anos", "Retorno a Tbilisi"] },
  { day: "Dia 9 — 15/06 (ter)", title: "Tbilisi", points: ["Praça Orbeliani e caminhada até o mercado de Pontes Secas, com artesanato e curiosidades da época soviética", "Tarde livre para explorar a cidade"] },
  { day: "Dia 10 — 16/06 (qua)", title: "Tbilisi → Baku", points: ["Traslado ao aeroporto e voo para Baku, capital do Azerbaijão", "Chegada e hospedagem no Baku Midtown Hotel"] },
  { day: "Dia 11 — 17/06 (qui)", title: "Baku · Ateshgah · Yanar Dag", points: ["Pista de Mártires, com vista panorâmica de Baku", "Centro histórico murado Icheri Sheher: Palácio de Shirvan Shash e Torre da Donzela", "Templo de fogo de Ateshgah, Patrimônio da UNESCO", "Yanar Dag, a montanha da chama eterna"] },
  { day: "Dia 12 — 18/06 (sex)", title: "Baku · Gobustan", points: ["Museu Heydar Aliyev, ícone da arquitetura moderna", "Reserva Natural de Gobustan, Patrimônio da UNESCO, com gravuras rupestres de 5.000 a 20.000 anos"] },
  { day: "Dia 13 — 19/06 (sáb)", title: "Baku", points: ["Dia livre para descanso e compras de última hora"] },
  { day: "Dia 14 — 20/06 (dom)", title: "Baku → Istambul", points: ["Traslado ao aeroporto e voo TK 333 às 11h30, chegada a Istambul às 13h45", "Conexão no voo TK 215 às 20h25 · pernoite a bordo"] },
  { day: "Dia 15 — 21/06 (seg)", title: "São Paulo", points: ["Chegada prevista a Guarulhos às 03h30", "Fim dos nossos serviços"] },
];
...
const faqs = [
  ...
  { q: "Como é o clima no Cáucaso em junho?", a: "Início do verão: dias longos e agradáveis nas capitais, com calor mais forte em Baku e noites frescas nas regiões de montanha, como Dilijan e o Lago Sevan. Leve camadas e um agasalho para a noite." },
...
const jsonLd = {
  ...
  name: GROUP_NAME,
  description: "Viagem de 15 dias pelo Cáucaso, de 7 a 21 de junho de 2027, com guia acompanhante desde o Brasil: Yerevan, Garni, Geghard, Khor Virap, Noravank, Lago Sevan, Tbilisi, Mtskheta, Uplistsikhe, Baku e Gobustan.",
  image: heroImg,
  ...
  offers: { "@type": "Offer", price: "5498.00", priceCurrency: "USD", availability: "https://schema.org/LimitedAvailability", validThrough: "2027-06-07", priceValidUntil: "2027-06-07" },
  provider: { "@id": "https://createtravel.tur.br/#organization" },
};

const GrupoCaucaso07Junho2027 = () => {
  const ctaLink = generateWhatsAppLink(whatsappParams);
  return (
    <div className="min-h-screen">
      <SEO title="Cáucaso Junho 2027 com Guia desde o Brasil | Create" description="15 dias por Armênia, Geórgia e Azerbaijão: Yerevan, Tbilisi, Baku, mosteiros milenares e Gobustan. Saída 07/06/2027 com guia desde o Brasil." canonicalPath={CANONICAL} ogImage={heroImg} ogType="article" jsonLd={[jsonLd, ...hotelsJsonLd]} keywords={`Cáucaso junho 2027, viagem em grupo Armênia Geórgia Azerbaijão, Cáucaso com guia brasileiro, excursão Cáucaso saindo de São Paulo, Turkish Airlines, Yerevan, Tbilisi, Baku, Gobustan, ${hotelsKeywords}`} />
      <Header />
      ...
      <section className="relative h-[92vh] flex items-center overflow-hidden">
        ...
        <div className="container-editorial relative z-10"><motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl">
          ...
          <p className="text-caption text-gold mb-4">Grupo com guia desde o Brasil · 7 a 21 de junho de 2027</p>
          <h1 className="heading-hero text-white mb-6">Cáucaso: Armênia, Geórgia e Azerbaijão em uma única jornada</h1>
          <p className="text-xl md:text-2xl text-white/90 mb-8 font-light">15 dias entre mosteiros milenares, o berço do vinho, montanhas e o Mar Cáspio — com guia acompanhante desde o Brasil.</p>
      ...
      <section className="bg-muted py-10 border-b border-border"><div className="container-editorial grid grid-cols-2 md:grid-cols-4 gap-6">{[
        { icon: Calendar, label: "Datas", value: "7 a 21/06/2027" }, { icon: Users, label: "Perfil", value: "Guia desde o Brasil" }, { icon: Plane, label: "Voos", value: "Turkish Airlines" }, { icon: Hotel, label: "Hospedagem", value: "Hotéis 1ª categoria" },
      ...
      <section id="investimento" className="section-padding bg-gradient-hero text-white"><div className="container-editorial max-w-4xl text-center"><p className="text-caption text-gold mb-4">Investimento</p><h2 className="heading-section mb-6">A partir de US$ 5.467 por pessoa</h2><p className="text-white/85 mb-8">Valores por pessoa, acrescidos de IOF e de USD 698 em taxas de aeroporto e combustível. Sujeitos a disponibilidade e confirmação aérea.</p><div className="grid sm:grid-cols-3 gap-4 mb-8 text-left">{[
        { label: "Apto triplo", price: "US$ 5.467", extra: "+ IOF US$ 143" }, { label: "Apto duplo", price: "US$ 5.498", extra: "+ IOF US$ 144" }, { label: "Apto individual", price: "US$ 6.245", extra: "+ IOF US$ 168" },
      ...
      <section className="section-padding"><div className="container-editorial text-center max-w-2xl"><h2 className="heading-section text-foreground mb-6">Vagas limitadas — grupo com guia desde o Brasil</h2><p className="text-muted-foreground mb-8">Fale com a curadoria Create Travel e consulte a disponibilidade para o Cáucaso em junho de 2027.</p><div className="flex flex-col sm:flex-row items-center justify-center gap-4"><a href={ctaLink} target="_blank" rel="noopener noreferrer" className="btn-whatsapp text-lg px-8 py-4">Falar no WhatsApp</a><Link to="/embarque-com-a-create" className="btn-outline">Ver outras saídas <ArrowRight size={18} /></Link></div></div></section>
      <Footer />
    </div>
  );
};

export default GrupoCaucaso07Junho2027;
