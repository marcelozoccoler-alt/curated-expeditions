...
const CANONICAL = "/grupos/sul-italia-maio-2027";
const GROUP_NAME = "Grupo Sul da Itália · Maio 2027 — Create Travel";
const whatsappParams = {
  type: "Roteiro" as const,
  name: "Grupo Sul da Itália · Maio 2027 (saída 17/05/2027)",
};
...
const itinerary = [
  { day: "Dia 1 — 17/05 (seg)", title: "São Paulo → Roma", points: ["Apresentação em Guarulhos e encontro com o coordenador", "Voo ITA Airways AZ 0679 às 18h55 com destino a Roma", "Pernoite a bordo"] },
  { day: "Dia 2 — 18/05 (ter)", title: "Roma → Nápoles → Sorrento", points: ["Chegada a Roma às 11h e conexão no voo AZ 1271 às 17h55", "Chegada a Nápoles às 18h50, recepção e traslado", "Hospedagem em Sorrento"] },
  { day: "Dia 3 — 19/05 (qua)", title: "Costa Amalfitana · Positano e Amalfi", points: ["Traslado ao embarcadouro de Sorrento e navegação em hidrofólio pela Costa Amalfitana", "Paisagens de Positano e Amalfi vistas do mar", "Em caso de mar impraticável, o passeio é feito por via terrestre"] },
  { day: "Dia 4 — 20/05 (qui)", title: "Sorrento", points: ["Dia livre", "Opcional (não incluso): dia inteiro na Ilha de Capri, com Anacapri, La Piazzetta e Jardins de Augusto"] },
  { day: "Dia 5 — 21/05 (sex)", title: "Sorrento → Pompeia → Borgo Venusio", points: ["Visita ao sítio arqueológico de Pompeia, soterrada pelo Vesúvio em 79 d.C.", "Viagem até a Basilicata", "Hospedagem em Borgo Venusio, ao lado de Matera"] },
  { day: "Dia 6 — 22/05 (sáb)", title: "Matera → Bari", points: ["Visita panorâmica aos Sassi de Matera, Patrimônio da UNESCO", "Casa Gruta de Vico Solitário", "Almoço livre (não incluso) e seguimos para Bari"] },
  { day: "Dia 7 — 23/05 (dom)", title: "Bari e Polignano a Mare", points: ["Basílica de San Nicola, Catedral de San Sabino e Castelo Normando-Suevo", "Bari Vecchia e a produção artesanal de massa nas portas das casas", "Polignano a Mare: praia de Lama Monachile, centro histórico e mirantes"] },
  { day: "Dia 8 — 24/05 (seg)", title: "Bari → Alberobello → Lecce", points: ["Alberobello e o Trullo Sovrano, hoje museu da vida rural da Puglia", "Almoço incluído (sem bebidas)", "Continuação até Lecce e hospedagem"] },
  { day: "Dia 9 — 25/05 (ter)", title: "Lecce e Otranto", points: ["Basílica de Santa Croce, Duomo di Lecce e Porta Napoli", "Almoço livre (não incluso)", "Otranto: catedral com o mosaico da Árvore da Vida, Baía dos Turcos e Cabo de Otranto"] },
  { day: "Dia 10 — 26/05 (qua)", title: "Lecce", points: ["Dia livre", "Opcional (não incluso): Gallipoli, no Mar Jônico, e Santa Maria di Leuca, onde o Adriático encontra o Jônico"] },
  { day: "Dia 11 — 27/05 (qui)", title: "Lecce → Brindisi → Roma → São Paulo", points: ["Apartamentos disponíveis até às 12h e traslado ao aeroporto de Brindisi", "Voo AZ 1622 às 15h15, chegada a Roma às 16h25", "Conexão no voo AZ 674 às 22h05 · pernoite a bordo"] },
  { day: "Dia 12 — 28/05 (sex)", title: "São Paulo", points: ["Chegada prevista a Guarulhos às 05h25 · fim dos nossos serviços"] },
];

const hotels = [
  { city: "Sorrento", hotel: "Michelangelo" },
  { city: "Borgo Venusio (Matera)", hotel: "Unahotels MH Matera" },
  { city: "Bari (Palese)", hotel: "Vittoria Parc" },
  { city: "Lecce", hotel: "Hilton Lecce" },
];
...
const jsonLd = {
  ...
  name: GROUP_NAME,
  description: "Viagem de 12 dias pelo sul da Itália em plena primavera, de 17 a 28 de maio de 2027, com guia acompanhante desde o Brasil: Costa Amalfitana, Pompeia, Matera, Bari, Alberobello, Lecce e Otranto.",
  image: heroImg,
  ...
  offers: { "@type": "Offer", price: "4757.00", priceCurrency: "EUR", availability: "https://schema.org/LimitedAvailability", validThrough: "2027-05-17", priceValidUntil: "2027-05-17" },
  provider: { "@id": "https://createtravel.tur.br/#organization" },
};

const GrupoSulItaliaMaio2027 = () => {
  const ctaLink = generateWhatsAppLink(whatsappParams);
  return (
    <div className="min-h-screen">
      <SEO title="Sul da Itália Maio 2027 com Guia desde o Brasil | Create" description="12 dias na primavera italiana: Costa Amalfitana, Pompeia, Matera, Bari, Alberobello, Lecce e Otranto. Saída 17/05/2027 com guia desde o Brasil." canonicalPath={CANONICAL} ogImage={heroImg} ogType="article" jsonLd={[jsonLd, ...hotelsJsonLd]} keywords={`Sul da Itália maio 2027, viagem em grupo Itália, Costa Amalfitana com guia brasileiro, Puglia, Matera, Lecce, ITA Airways, ${hotelsKeywords}`} />
      <Header />
      ...
      <section className="relative h-[92vh] flex items-center overflow-hidden">
        ...
        <div className="container-editorial relative z-10"><motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="max-w-3xl">
          ...
          <p className="text-caption text-gold mb-4">Grupo com guia desde o Brasil · 17 a 28 de maio de 2027</p>
          <h1 className="heading-hero text-white mb-6">Sul da Itália: uma primavera à beira do Mediterrâneo</h1>
      ...
      <section className="bg-muted py-10 border-b border-border"><div className="container-editorial grid grid-cols-2 md:grid-cols-4 gap-6">{[
        { icon: Calendar, label: "Datas", value: "17 a 28/05/2027" }, { icon: Users, label: "Perfil", value: "Guia desde o Brasil" }, { icon: Plane, label: "Voos", value: "ITA Airways" }, { icon: Hotel, label: "Hospedagem", value: "Hotéis 1ª categoria" },
      ...
      <section className="section-padding"><div className="container-editorial text-center max-w-2xl"><h2 className="heading-section text-foreground mb-6">Lugares limitados — grupo com guia desde o Brasil</h2><p className="text-muted-foreground mb-8">Fale com a curadoria Create Travel e consulte a disponibilidade para o sul da Itália em maio de 2027.</p><div className="flex flex-col sm:flex-row items-center justify-center gap-4"><a href={ctaLink} target="_blank" rel="noopener noreferrer" className="btn-whatsapp text-lg px-8 py-4">Falar no WhatsApp</a><Link to="/embarque-com-a-create" className="btn-outline">Ver outras saídas <ArrowRight size={18} /></Link></div></div></section>
      <Footer />
    </div>
  );
};

export default GrupoSulItaliaMaio2027;
